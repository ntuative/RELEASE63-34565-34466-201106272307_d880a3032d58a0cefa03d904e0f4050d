package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_1960 = param1.invDigit();
         this.var_1961 = this.var_1960 & 32767;
         this.var_2711 = this.var_1960 >> 15;
         this.var_2710 = 131071;
         this.var_2712 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_186) > 0)
         {
