package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1366:String = "AssetLibraryReady";
      
      public static const const_895:String = "AssetLibraryLoaded";
      
      public static const const_1796:String = "AssetLibraryUnloaded";
      
      public static const const_1770:String = "AssetLibraryLoadError";
      
      private static const const_694:String = "name";
      
      private static const const_1065:String = "asset";
      
      private static const const_1066:String = "param";
      ...
      private static var var_1788:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_529:uint = 0;
      
      private static var var_962:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_961 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         var _loc5_:XMLList = param2.child(const_1064);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1065);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_694);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1066);
                  if(_loc11_.length())
                  {
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_962.splice(var_962.indexOf(this),1);
            --var_529;
            this.var_530 = null;
            this.var_961 = null;
            this.var_169 = null;
      ...
      {
         if(this.var_629 == param1.url && this.var_964)
         {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_961)
         {
            delete this.var_961[_loc1_];
         }
         if(this.var_45 != null)
         {
            this.var_45.dispose();
         ...
         this.var_964 = false;
         this.var_629 = null;
         dispatchEvent(new Event(AssetLibrary.const_1796));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_961[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1271,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1374,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1282,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1235,this.assetLoadEventHandler);
      ...
      {
         return this.var_169[param1] != null || (this.var_628 != null ? this.var_628[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1788.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_964 = true;
         dispatchEvent(new Event(AssetLibrary.const_895));
         dispatchEvent(new Event(AssetLibrary.const_1366));
         if(this.var_963)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1770));
         this.var_45 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1064);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1065);
            if(_loc2_ != null)
            {
               _loc5_ = null;
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_694) && _loc3_.attribute(const_694).toString() == param1)
                  {
                     ...
                     _loc6_ = _loc3_.child(const_1066);
