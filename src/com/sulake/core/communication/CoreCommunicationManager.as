package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      public function CoreCommunicationManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_1359 = new Dictionary();
         this.var_901 = new Dictionary();
      ...
      override public function dispose() : void
      {
         ...
         this.var_1359 = null;
         this.var_2139 = null;
         for each(_loc2_ in this.var_901)
         {
            while(true)
            {
         ...
         this.var_901 = null;
         for each(_loc3_ in this.var_1663)
         {
         }
         var _loc5_:* = null;
         this.var_1359 = null;
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_1379:
               _loc3_ = new SocketConnection(param1,this,this.var_2139);
               break;
            default:
      ...
      {
         var _loc2_:Class = this.var_1359[param1];
         var _loc3_:* = null;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:Array = this.var_901[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            this.var_901[param1] = _loc3_;
         }
         _loc3_.push(param2);
      }
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc5_:Array = this.var_901[_loc3_];
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in this.var_1663)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)
