package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_2205:uint = 1;
      ...
      private var var_593:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_593 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_593.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_593.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            this.var_1411 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1411);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1688 & const_1351)
         {
            if(_loc3_ == 0)
            {
               if(this.var_593.getTotalReferenceCount() == 0)
               {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_797 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_593.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_593.getStructByIndex(_loc8_);
