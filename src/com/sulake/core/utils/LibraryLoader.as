package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_2046:uint = 1;
      
      protected static const const_2047:uint = 2;
      
      protected static const const_2045:uint = 4;
      
      protected static const const_2044:uint = 3;
      ...
      public static const const_1353:Boolean = false;
      
      public static const const_1858:int = 2;
      
      private static var var_1034:Array = new Array();
      
      private static var var_853:Array = new Array();
      ...
      protected var var_3121:uint = 0;
      
      protected var var_3045:Boolean = true;
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         ...
         {
            param1.var_45.load(param1.var_266,param1._context);
         }
      }
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1353)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_853[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_853.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_853.length < const_1858 && false)
            {
               _loc1_ = var_1034.shift() as LibraryLoader;
               if(!_loc1_.ready && !_loc1_.disposed)
               {
                  var_853.push(_loc1_);
                  _loc1_.var_45.load(_loc1_.var_266,_loc1_._context);
               }
            }
         }
      }
      ...
      {
         return !!this.var_1148 ? uint(this.var_1421 - this.var_2249) : uint(getTimer() - this.var_2249);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DISPOSE,this.var_428,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
            try
            {
               this.var_45.close();
            }
      ...
      {
         if(!this.var_1148 && !_disposed && this.var_1420 > 0)
         {
            try
            {
               this.var_45.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_266,const_1744 - this.var_1420);
            if(this.var_3045)
            {
            ...
            --this.var_1420;
            this.var_508 = 0;
            this.var_45.load(this.var_266,this._context);
            return true;
         }
         return false;
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               this.var_428 = HTTPStatusEvent(param1).status;
               this.debug("Load event STATUS " + this.var_428 + " for file \"" + this.url + "\"");
               break;
            case Event.UNLOAD:
               this.debug("Load event UNLOAD for file \"" + this.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_UNLOAD,this.var_428,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case ProgressEvent.PROGRESS:
               this.debug("Load event PROGRESS for file \"" + this.url + "\"  bytes: " + this.bytesLoaded + "/" + this.bytesTotal);
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_PROGRESS,this.var_428,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case IOErrorEvent.IO_ERROR:
               this.debug("Load event IO ERROR for file \"" + this.url + "\"");
               if(!this.handleHttpStatus(this.var_428))
               {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_508 = LibraryLoader.name_5;
         ...
         if(this.var_508 == LibraryLoader.const_2044)
         {
         ...
         if(this.var_508 == LibraryLoader.name_5)
         {
            if(this.prepareLibrary())
            {
               ...
               this.removeEventListeners();
               throttle();
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,this.var_428,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
      ...
      protected function debug(param1:String) : void
      {
         ...
         if(this._debug)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DEBUG,this.var_428,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         }
      }
      ...
      protected function failure(param1:String) : void
      {
         ...
         throttle();
         dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,this.var_428,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         dispatchEvent(new Event(LIBRARY_LOADER_FINALIZE));
      }
