package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowEvent = WindowEvent.allocate(WindowEvent.const_332,this,null,true);
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_192 == null || this.var_192.disposed)
         {
            this.var_192 = context.create(name + "::submenu","",WindowType.const_536,var_91,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_950 = false;
            this.getTitleLabel().text = this.var_619 < this.var_270.length && this.var_619 > -1 ? this.var_270[this.var_619] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_438,var_91,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         {
            _loc4_.getListItemAt(this.var_619).setStateFlag(WindowState.const_55,true);
         }
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1210:
            case WindowMouseEvent.const_56:
               ...
               break;
            case WindowTouchEvent.const_927:
      ...
      public function open() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1740,this,null);
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1823,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         visible = false;
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1961,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_270.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_763,this.var_270,PropertyStruct.const_143,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1923);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_763)
            {
