package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1591:String = "_TITLE";
      
      private static const const_1589:String = "_HEADER";
      
      private static const const_1590:String = "_CONTENT";
      
      private static const const_1588:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1587:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1591) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1587 = findChildByTag(const_1589) as IHeaderWindow;
            if(!this.var_1587)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_197 = findChildByTag(const_1590) as IWindowContainer;
            if(!this.var_197)
            {
      ...
      {
         return findChildByTag(const_1588) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1412,_loc2_,false);
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_336);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_305);
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_324,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_293,_loc3_.left,PropertyStruct.const_37,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_290,_loc3_.top,PropertyStruct.const_37,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_282,0 - _loc3_.right,PropertyStruct.const_37,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_277,0 - _loc3_.bottom,PropertyStruct.const_37,_loc2_));
         return _loc1_;
      }
