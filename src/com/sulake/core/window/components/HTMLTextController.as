package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1012:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_1874:StyleSheet = null;
      ...
      {
         this.var_824 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1244 == param2)
         {
            return;
         }
         param1.var_1244 = param2;
         param1.var_1874 = null;
         if(param1.var_1244 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1244);
            param1.var_1874 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_833.indexOf(param1) > -1)
         {
            this.var_824 = param1;
         }
      }
      ...
      {
         return this.var_824 == LinkTarget.const_30 ? defaultLinkTarget : this.var_824;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1874;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1262)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_824 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_818,this.var_824,PropertyStruct.const_51,true,PropertyDefaults.const_833));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1955);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_818)
            {
               this.var_824 = _loc2_.value as String;
               break;
            }
