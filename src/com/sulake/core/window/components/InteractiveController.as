   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      public static function readInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : void
      {
         ...
         for each(_loc3_ in param2)
         {
            switch(_loc3_.key)
            {
               case PropertyDefaults.const_947:
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_671)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_947,param1.toolTipCaption,PropertyStruct.const_51,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1881);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1185)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_1026,param1.toolTipDelay,PropertyStruct.const_258,true));
         }
         else
         {
      ...
      {
         this.var_1418 = param1 == null ? "null" : param1;
      }
