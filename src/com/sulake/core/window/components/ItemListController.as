package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2266:Boolean = false;
      ...
      protected var var_1154:Boolean = true;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this._container = _context.create("_CONTAINER","",WindowType.const_438,WindowStyle.const_103,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
      ...
      {
         return new Rectangle(this.var_754 * this.maxScrollH,this.var_755 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_754 = param1;
            this._container.x = -this.var_754 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_61);
            _loc2_ = WindowEvent.allocate(WindowEvent.const_602,this,null);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_193:
               if(this.var_1427)
               {
                  this.var_1428 = this.var_2265 - _loc3_;
                  this.var_1429 = this.var_2267 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1428 != 0 && this.var_124 != 0)
                     {
                        this.scrollH += this.var_1428 / this.var_124;
                     }
                  }
                  else if(this.var_1429 != 0 && this.var_108 != 0)
                  {
                     this.scrollV += this.var_1429 / this.var_108;
                  }
                  this.var_2265 = _loc3_;
                  this.var_2267 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_309:
               if(this.var_1427)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1428,0);
                  }
                  else
                  {
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1154 && !this.var_610 && this._container)
         {
            this.var_610 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_786)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_458,this._spacing,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1241);
         }
         if(this.var_1154 != PropertyDefaults.const_1378)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_754,this.var_1154,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1888);
         }
         if(this.var_515 != PropertyDefaults.const_1164)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_965,this.var_515,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1739);
         }
         if(this.var_1426 != PropertyDefaults.const_1391)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_812,this.var_1426,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1947);
         }
         if(this.var_756 != PropertyDefaults.const_1288)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_861,this.var_756,PropertyStruct.const_131,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1841);
         }
         if(this.var_757 != PropertyDefaults.const_1263)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_933,this.var_757,PropertyStruct.const_131,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1826);
         }
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_754:
                  this.var_1154 = _loc2_.value as Boolean;
                  break;
