package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1167:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_437)
         {
            this.var_437.removeEventListener(WindowEvent.const_301,this.scrollBarEventProc);
            this.var_437.removeEventListener(WindowEvent.const_294,this.scrollBarEventProc);
            this.var_437 = null;
         }
         if(this.var_1167)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1167)
         {
            this.var_1167 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_437)
         {
            ...
            if(this.var_437)
            {
               this.var_437.addEventListener(WindowEvent.const_301,this.scrollBarEventProc);
               this.var_437.addEventListener(WindowEvent.const_294,this.scrollBarEventProc);
            }
         }
         return this.var_437;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_294)
         {
            this.hideScrollBar();
         }
      }
