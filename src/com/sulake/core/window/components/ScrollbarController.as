package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1574:String = "increment";
      
      private static const const_1575:String = "decrement";
      
      private static const const_1107:String = "slider_track";
      
      private static const const_710:String = "slider_bar";
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_18 != null && !this.var_18.disposed)
         {
            ...
            this.var_18.removeEventListener(WindowEvent.const_602,this.onScrollableScrolled);
         }
         this.var_18 = param1;
         if(this.var_18 != null && !this.var_18.disposed)
         {
            this.var_18.addEventListener(WindowEvent.const_40,this.onScrollableResized);
            this.var_18.addEventListener(WindowEvent.const_602,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         else if(this.var_1048 != null)
         {
            _loc2_ = this.var_1048;
         }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_1048 = _loc3_.value as String;
               this.var_18 = null;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_1107) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_710) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_710:
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_341)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_750;
                  }
                  else
                  {
                     this.scrollV -= this.var_750;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_43 || param1.type == WindowTouchEvent.const_856)
         {
            if(param2.name == const_1574)
            {
               if(this.var_18)
               {
                  this.var_1302 = true;
            ...
            else if(param2.name == const_1575)
            {
               if(this.var_18)
               {
                  this.var_1302 = true;
            ...
            else if(param2.name == const_1107)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_710).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_341)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_1048) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_1048) as IScrollableWindow;
               if(_loc1_)
               {
