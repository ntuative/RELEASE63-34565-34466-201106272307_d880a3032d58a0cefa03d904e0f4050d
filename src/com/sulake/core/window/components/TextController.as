package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_225);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_781 ? true : null;
         }
      ...
      {
         return new Rectangle(this.var_932 * this.maxScrollH,this.var_604 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_978,this._field.antiAliasType,PropertyStruct.const_51,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1232));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1255 ? new PropertyStruct(PropertyDefaults.const_985,this._autoSize,PropertyStruct.const_51,true,PropertyDefaults.const_1327) : PropertyDefaults.const_1978);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_35,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_144,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_258,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1328 ? new PropertyStruct(PropertyDefaults.const_1289,this._field.gridFitType,PropertyStruct.const_51,true,PropertyDefaults.const_1363) : PropertyDefaults.const_1743);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_1016) ? new PropertyStruct(PropertyDefaults.const_440,this._field.textColor,PropertyStruct.const_144,true) : PropertyDefaults.const_1334);
         _loc1_.push(this.var_463 != TextStyleManager.const_225 ? new PropertyStruct(PropertyDefaults.const_429,this.var_463,PropertyStruct.const_51,true,PropertyDefaults.const_949) : PropertyDefaults.const_1274);
         _loc1_.push(this.var_43.left != PropertyDefaults.const_989 ? new PropertyStruct(PropertyDefaults.const_293,this.var_43.left,PropertyStruct.const_37,true) : PropertyDefaults.const_1006);
         _loc1_.push(this.var_43.top != PropertyDefaults.const_772 ? new PropertyStruct(PropertyDefaults.const_290,this.var_43.top,PropertyStruct.const_37,true) : PropertyDefaults.const_1014);
         _loc1_.push(this.var_43.right != PropertyDefaults.const_831 ? new PropertyStruct(PropertyDefaults.const_282,this.var_43.right,PropertyStruct.const_37,true) : PropertyDefaults.const_813);
         _loc1_.push(this.var_43.bottom != PropertyDefaults.const_784 ? new PropertyStruct(PropertyDefaults.const_277,this.var_43.bottom,PropertyStruct.const_37,true) : PropertyDefaults.const_972);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1310 ? new PropertyStruct(PropertyDefaults.const_774,this._field.mouseWheelEnabled,PropertyStruct.const_35,true) : PropertyDefaults.const_1962);
