package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1705:uint = 500;
      
      protected var var_1418:String = "";
      
      protected var var_1425:Boolean = false;
      
      protected var var_796:Boolean = false;
      ...
      {
         this.var_1418 = param1 == null ? "" : param1;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_796 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_426,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_19 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_344,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_1003,false,PropertyStruct.const_35,true) : PropertyDefaults.const_1887);
         _loc1_.push(this.var_1425 != PropertyDefaults.const_1350 ? new PropertyStruct(PropertyDefaults.const_958,this.var_1425,PropertyStruct.const_35,true) : PropertyDefaults.const_1922);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1286 ? new PropertyStruct(PropertyDefaults.const_735,_field.selectable,PropertyStruct.const_35,true) : PropertyDefaults.const_1878);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1260 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_35,true) : PropertyDefaults.const_1749);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_735:
                  ...
                  break;
               case PropertyDefaults.const_1003:
                  _field.type = !!_loc2_.value ? "null" : TextFieldType.DYNAMIC;
                  break;
               case PropertyDefaults.const_1297:
