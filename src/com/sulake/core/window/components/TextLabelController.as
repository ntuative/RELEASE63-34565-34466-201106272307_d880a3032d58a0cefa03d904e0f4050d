package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2390 = _loc2_.textWidth;
         this.var_2389 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_366 != _loc2_.color : this.var_366 != null && this.var_366 != PropertyDefaults.const_1016) ? new PropertyStruct(PropertyDefaults.const_440,this.var_366,PropertyStruct.const_144,true) : PropertyDefaults.const_1334);
         if(this.var_43)
         {
            if(this.var_43.left != PropertyDefaults.const_989)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_293,this.var_43.left,PropertyStruct.const_37,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_1006);
            }
            if(this.var_43.top != PropertyDefaults.const_772)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_290,this.var_43.top,PropertyStruct.const_37,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_1014);
            }
            if(this.var_43.right != PropertyDefaults.const_831)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_282,this.var_43.right,PropertyStruct.const_37,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_813);
            }
            if(this.var_43.bottom != PropertyDefaults.const_784)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_277,this.var_43.bottom,PropertyStruct.const_37,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_972);
            }
         }
         else
         {
