         ...
         if(_loc8_.length() > 0)
         {
            ...
            switch(_loc6_.toLowerCase())
            {
               case "fixed":
                  ...
                  break;
               case "move":
                  _loc5_.var_355 = SkinLayoutEntity.const_342;
                  break;
               case "strech":
                  _loc5_.var_355 = SkinLayoutEntity.const_505;
                  break;
               case "tiled":
                  _loc5_.var_355 = SkinLayoutEntity.const_346;
                  break;
               case "center":
                  _loc5_.var_355 = SkinLayoutEntity.const_490;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_353 = SkinLayoutEntity.const_597;
                  break;
               case "move":
                  _loc5_.var_353 = SkinLayoutEntity.const_342;
                  break;
               case "strech":
                  _loc5_.var_353 = SkinLayoutEntity.const_505;
                  break;
               case "tiled":
                  _loc5_.var_353 = SkinLayoutEntity.const_346;
                  break;
               case "center":
                  _loc5_.var_353 = SkinLayoutEntity.const_490;
            }
         }
