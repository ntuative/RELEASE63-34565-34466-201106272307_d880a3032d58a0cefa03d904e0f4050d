package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_2275:uint = 64;
      
      public static const const_2309:uint = 128;
      ...
      protected var var_936:Boolean;
      
      protected var _disposed:Boolean = false;
      
      protected var var_11:Rectangle;
      
      protected var var_209:Shape;
      ...
      public function setDrawRegion(param1:Rectangle, param2:Boolean, param3:Rectangle) : void
      {
         ...
         if(param3)
         {
            if(!this.var_209)
            {
               this.var_209 = new Shape();
               this.var_209.visible = false;
               this.var_209.cacheAsBitmap = true;
               super.addChild(this.var_209);
            }
            this.var_209.graphics.clear();
            this.var_209.graphics.beginFill(255);
            this.var_209.graphics.drawRect(param3.x,param3.y,param3.width,param3.height);
            this.var_209.graphics.endFill();
            this.getDisplayObject().mask = this.var_209;
         }
         else if(this.var_209)
         {
            super.removeChild(this.var_209);
            this.var_209.graphics.clear();
            this.var_209 = null;
         ...
         if(this.var_936)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2253,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2253,16777215);
                  }
                  var_362 += bitmap.width * bitmap.height * 4;
               }
