package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1070:uint = 8;
      
      private static const const_1499:String = "skin";
      
      private static const const_1502:String = "bitmap";
      
      private static const const_1501:String = "fill";
      
      private static const const_1504:String = "text";
      
      private static const const_1503:String = "label";
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(this.var_1825,this.var_2482);
         this.var_2481 = new Dictionary();
         this.var_2480 = new Dictionary();
         StateCodeTable.fillTables(this.var_2481,this.var_2480);
         this.var_450 = new Dictionary();
         this.var_450[const_1499] = BitmapSkinRenderer;
         this.var_450[const_1502] = BitmapDataRenderer;
         this.var_450[const_1501] = FillSkinRenderer;
         this.var_450[const_1504] = TextSkinRenderer;
         this.var_450[const_1503] = LabelRenderer;
         this.var_450[const_1500] = ShapeSkinRenderer;
         this.var_450[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_450[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_360 == null)
         {
            var_360 = new Array();
            var_360.push(WindowState.const_74);
            var_360.push(WindowState.const_89);
            var_360.push(WindowState.const_95);
            var_360.push(WindowState.const_55);
            var_360.push(WindowState.const_94);
            var_360.push(WindowState.const_91);
            var_360.push(WindowState.const_88);
            var_360.push(WindowState.const_106);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  this.addSkinRenderer(this.var_1825[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_979[param1] == null)
         {
            this.var_979[param1] = new Array(const_1070);
         }
         this.var_979[param1][param2] = param3;
         if(this.var_978[param1] == null)
         {
            this.var_978[param1] = new Array(const_1070);
         }
         this.var_978[param1][param2] = param4;
      }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_978[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_103)
