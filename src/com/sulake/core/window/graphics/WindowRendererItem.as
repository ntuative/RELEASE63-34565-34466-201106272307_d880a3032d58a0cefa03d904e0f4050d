package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_1097:uint = 2;
       
      
      private var var_134:BitmapData;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this._drawBufferAllocator.free(this.var_134);
               this.var_134 = null;
            }
         }
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc5_:uint = !!param1.background ? uint(const_1097) : uint(const_703);
         var _loc6_:Boolean = this.var_199.width > 0 && this.var_199.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_1031))
            {
               _loc5_ = const_1098;
            }
         }
         ...
         if(_loc5_ != const_703)
         {
            if(this.var_134 == null)
            {
               this.var_134 = this._drawBufferAllocator.allocate(_loc8_,_loc9_,true,param1.color);
               this.var_670 = true;
               _loc6_ = true;
               _loc10_ = false;
            }
            else if(this.var_134.width != _loc8_ || this.var_134.height != _loc9_)
            {
               this._drawBufferAllocator.free(this.var_134);
               this.var_134 = this._drawBufferAllocator.allocate(_loc8_,_loc9_,true,param1.color);
               this.var_670 = true;
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_1098)
               {
                  ...
                  if(this.var_670)
                  {
                     ...
                     if(_loc10_)
                     {
                        this.var_134.fillRect(this.var_134.rect,param1.color);
                     }
                     _loc7_.draw(param1,this.var_134,this.var_134.rect,this.var_1031,false);
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_33))
                  {
                     this.var_1150.tx = param2.x;
                     this.var_1150.ty = param2.y;
                     this.var_793.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_134,this.var_1150,this.var_793,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
                     _loc4_.copyPixels(this.var_134,param3,param2,null,null,true);
                  }
               }
               else if(_loc5_ == const_1097)
               {
                  _loc6_ = true;
                  if(param1.testParamFlag(WindowParam.const_33))
                  {
      ...
      {
         return this._skinContainer.getTheActualState(param1.type,param1.style,param1.state) != this.var_1548;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_1321:
               ...
               break;
            case WindowRedrawFlag.const_956:
               this.var_1031 = this._skinContainer.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_1031 != this.var_1548)
               {
                  this.var_670 = true;
                  _loc4_ = true;
               }
