package com.sulake.core.window.services
{
   ...
   public class WindowMouseOperator implements IDisposable
   {
      ...
      protected var var_749:Point;
      
      protected var var_1688:uint;
      ...
      public function operate(param1:int, param2:int) : void
      {
         ...
         this.getMousePositionRelativeTo(this._window,this._mouse,this.var_749);
         this._window.offset(this.var_749.x - this._offset.x,this.var_749.y - this._offset.y);
      }
