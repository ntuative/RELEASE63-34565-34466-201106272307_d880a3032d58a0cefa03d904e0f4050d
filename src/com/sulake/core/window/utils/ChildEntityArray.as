package com.sulake.core.window.utils
{
   public class ChildEntityArray extends ChildEntityArrayReader implements IChildEntityArray
   {
      ...
      {
         var _loc2_:int = var_35.indexOf(param1);
         if(_loc2_ < 0)
         {
            return null;
         }
      ...
      {
         var_35.splice(param2,0,param1);
         return param1;
      }
      
      public function removeChildAt(param1:int) : IChildEntity
      {
         var _loc2_:IChildEntity = var_35[param1];
         if(_loc2_ != null)
         {
            var_35.splice(param1,1);
            return _loc2_;
         }
         return null;
      }
      ...
      {
         var _loc3_:int = var_35.indexOf(param1);
         if(_loc3_ > -1 && param2 != _loc3_)
         {
            var_35.splice(_loc3_,1);
            var_35.splice(param2,0,param1);
         }
      }
      ...
      public function swapChildren(param1:IChildEntity, param2:IChildEntity) : void
      {
         ...
         {
            _loc3_ = var_35.indexOf(param1);
            if(_loc3_ < 0)
            {
               return;
            }
            _loc4_ = var_35.indexOf(param2);
            if(_loc4_ < 0)
            {
               return;
            }
            ...
            var_35.splice(_loc3_,1);
            var_35.splice(_loc3_,0,param2);
            var_35.splice(_loc4_,0,param1);
         }
      }
      
      public function swapChildrenAt(param1:int, param2:int) : void
      {
         this.swapChildren(var_35[param1],var_35[param2]);
      }
   }
}
