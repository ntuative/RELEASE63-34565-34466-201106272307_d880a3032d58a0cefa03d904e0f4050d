package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected static var var_314:Array;
      
      protected static var var_433:Point = new Point();
       
      
      protected var var_745:Point;
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_361 = new Array();
            var_361[0] = MouseCursorType.const_322;
            var_361[1] = MouseCursorType.const_30;
            var_361[2] = MouseCursorType.const_322;
            var_361[3] = MouseCursorType.const_322;
            var_361[4] = MouseCursorType.const_322;
            var_361[5] = MouseCursorType.const_30;
            var_361[6] = MouseCursorType.const_322;
         }
         if(var_314 == null)
         {
            var_314 = new Array();
            var_314[0] = WindowState.const_88;
            var_314[1] = WindowState.const_91;
            var_314[2] = WindowState.const_94;
            var_314[3] = WindowState.const_74;
            var_314[4] = WindowState.const_55;
            var_314[5] = WindowState.const_95;
            var_314[6] = WindowState.const_89;
         }
      }
      
      public static function setMouseCursorByState(param1:uint, param2:uint) : void
      {
         var _loc3_:int = var_314.indexOf(param1);
         if(_loc3_ > -1)
         {
            var_361[_loc3_] = param2;
         }
      }
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_188 = state.var_1406 as WindowController;
         this.var_185 = state.renderer;
         this.var_931 = state.var_1408;
         eventQueue.begin();
         this.var_745.x = -1;
         this.var_745.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_745.x || event.stageY != this.var_745.y)
            {
               this.var_745.x = event.stageX;
               this.var_745.y = event.stageY;
               array = new Array();
               this.var_95.groupParameterFilteredChildrenUnderPoint(this.var_745,array,WindowParam.const_31);
            }
         ...
         state.var_1406 = this.var_188;
         state.renderer = this.var_185;
         state.var_1408 = this.var_931;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         var _loc5_:BitmapData = this.var_185.getDrawBufferForRenderable(param1);
