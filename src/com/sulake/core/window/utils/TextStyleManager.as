package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_225:String = "regular";
      ...
      private static const const_700:String = "{";
      
      private static const const_701:String = "}";
      
      private static const const_1510:String = "/*";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_98[const_225],var_98[ITALIC],var_98[BOLD]];
            var_98.reset();
            var_98[const_225] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         if(countSubStrings(param1,const_700) != countSubStrings(param1,const_701))
         {
            throw new Error("Mismatching amount of \"" + const_700 + "\" versus \"" + const_701 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1510) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1511) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_700)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
