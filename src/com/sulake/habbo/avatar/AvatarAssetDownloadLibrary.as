package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_2154:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this.var_1370 = param3 + this.var_911 + ".swf";
         this.var_1370 = this.var_1370.replace("%revision%",this._revision);
      ...
      {
         this._state = var_2154;
         var _loc1_:URLRequest = new URLRequest(this.var_1370);
      ...
      {
         Core.error("Could not load avatar asset library " + this.var_911 + " from URL " + this.var_1370,false,Core.const_1199);
      }
