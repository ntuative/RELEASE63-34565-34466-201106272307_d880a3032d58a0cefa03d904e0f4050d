package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1698:IWindowContainer;
      
      public static var var_2235:int = 6710886;
      
      private static const const_1552:int = 5000;
      
      private static const const_1492:Point = new Point(100,30);
      ...
      private var var_248:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:Array)
      {
         ...
         var _loc5_:* = null;
         this.var_1254 = [];
         this.var_1523 = [AvatarEditorFigureCategory.const_794,AvatarEditorFigureCategory.const_58,AvatarEditorFigureCategory.const_252,AvatarEditorFigureCategory.const_929,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_110];
         super();
         this.var_24 = param1;
         if(var_1407 == null)
         {
            _loc4_ = this.var_24.manager.assets.getAssetByName("AvatarEditorThumb") as XmlAsset;
            var_1407 = this.var_24.manager.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
         if(var_1698 == null)
         {
            _loc5_ = this.var_24.manager.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1698 = this.var_24.manager.windowManager.buildFromXML(_loc5_.content as XML) as IWindowContainer;
         }
         this.var_664 = new Timer(const_1552,1);
         this.var_664.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param2 == null)
         {
            param2 = this.var_1523;
         }
         for each(_loc3_ in param2)
         {
            this.var_1254.push(_loc3_);
         }
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_664.stop();
            this.var_664.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_664 = null;
         }
         if(this.var_248)
         {
      ...
      public function getFrame(param1:Array, param2:String = null) : IFrameWindow
      {
         ...
         this.var_87.position = const_1492;
      ...
      public function embedToContext(param1:IWindowContainer, param2:Array) : Boolean
      {
         ...
         else
         {
            if(this.var_663 == null)
            {
               this.var_663 = this.var_24.manager.windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_79,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_663.addChild(this.var_59);
            }
            _loc3_ = this.var_663.getChildIndex(this.var_59);
            if(_loc3_)
            {
               param1.removeChildAt(_loc3_);
            }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1523);
         }
         if(param1.length != this.var_1254.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1254.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function createWindow() : void
      {
         ...
         this.var_248 = this.var_59.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc1_:int = this.var_248.numSelectables - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_248.getSelectableAt(_loc1_);
            if(_loc2_ != null && this.var_1254.indexOf(_loc2_.name) < 0)
            {
               _loc3_ = this.var_248.removeSelectable(_loc2_);
               _loc4_ = _loc1_ + 1;
               while(_loc4_ < this.var_248.numSelectables)
               {
                  this.var_248.getSelectableAt(_loc4_).x = this.var_248.getSelectableAt(_loc4_).x - _loc3_.width;
                  _loc4_++;
               }
            }
            _loc1_--;
         }
         this.var_248.setSelected(this.var_248.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1523;
      ...
      public function update() : void
      {
         ...
         if(this.var_24.manager.sessionData && this.var_24.manager.sessionData.clubLevel >= HabboClubLevelEnum.const_38 && (this.var_1522 == AvatarEditorSideCategory.const_110 || this.var_2621))
         {
            _loc4_ = "null";
         }
      ...
      {
         if(this.var_1522 == AvatarEditorSideCategory.const_110)
         {
            this.var_2621 = false;
            this.setSideContent(AvatarEditorSideCategory.const_506);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_506:
               break;
            case AvatarEditorSideCategory.const_654:
               _loc3_ = this.var_24.getSideContentWindowContainer(AvatarEditorSideCategory.const_654);
               break;
            case AvatarEditorSideCategory.const_110:
               _loc3_ = this.var_24.getSideContentWindowContainer(AvatarEditorSideCategory.const_110);
         }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_389 = param1;
         this.var_248.setSelected(this.var_248.getSelectableByName(param1));
      }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_325)
         {
            ...
            this.var_325 = this.var_24.manager.windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
      ...
      private function openCatalogClubPage() : void
      {
         ...
         {
            this.var_24.manager.catalog.openCatalogPage(CatalogPageName.const_130,true);
         }
      }
   }
}
