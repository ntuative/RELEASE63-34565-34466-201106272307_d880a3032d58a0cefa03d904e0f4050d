package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      protected var var_602:IAvatarDataContainer;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_58 || param1 == AvatarSetType.const_42)
         {
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_276.length == 1 && this.var_101 == this.var_2101)
         {
            return this.var_101 + this.var_538 + this.var_644 % 4;
         }
      ...
      {
         if(param3 != this.var_2493 || param2 != this.var_2492 || param1 != this.var_2491)
         {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_309.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1412 || this.var_47 == null || (this.var_47.width != _loc5_.width || this.var_47.height != _loc5_.height))
         {
            if(this.var_47 != null && !this.var_1412)
            {
               this.var_47.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_309.definition.geometryType,this.var_101);
         this.var_47.lock();
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_357.push(new ActiveActionData(param1,param2,this.var_644));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.resetBodyPartCache(this.var_1039);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_538 = "";
         this.var_276 = this._structure.sortActions(this.var_357);
         if(this.var_276 == null)
         {
         ...
         {
            this.var_765 = this._structure.getCanvasOffsets(this.var_276,this._scale,this.var_101);
            for each(_loc4_ in this.var_276)
            {
               this.var_538 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_364)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1492 != _loc5_)
                  {
                     _loc2_ = true;
                  }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_276)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_955 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
               ...
               if(_loc1_.actionType == AvatarAction.const_345 || _loc1_.actionType == AvatarAction.const_260 || _loc1_.actionType == AvatarAction.const_430)
               {
                  this.var_955 = true;
               }
            }
