package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_906:PaletteManager;
      
      private var var_725:String;
      
      private var var_349:Map;
      
      private var var_260:AvatarAssetDownloadManager;
      
      private var var_2144:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_725 = RenderMode.const_1866;
         ...
         this.var_121.add(AvatarType.const_127,_loc4_);
         ...
         this.var_906 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_260)
         {
            this.var_260.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_348.init();
         this.var_906.init();
         _loc2_ = this.var_121.getValue(AvatarType.const_127) as AvatarStructure;
         if(_loc2_)
         {
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_121.getValue(AvatarType.const_127) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_150.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_260 == null)
               {
                  ...
                  _loc6_ = this.var_150.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_150.getKey("flash.dynamic.avatar.download.url","");
                  this.var_260 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_260.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_964)
         {
            if(this.var_2959 && this.var_2960 && this.var_2961)
            {
               this.var_964 = true;
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_260.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_260.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_121.getValue(AvatarType.const_127) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_260.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_2144)
         {
            this.var_2144 = new AvatarFigureContainer(this.const_2376);
         }
         this.var_260.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_2144,param2);
      }
      ...
      public function method_4(param1:String, param2:String, param3:IPetImageListener = null) : IAvatarImage
      {
         if(param1.indexOf(" ") == -1)
         {
            return null;
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1934)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_121.getValue(AvatarType.const_127) as AvatarStructure;
