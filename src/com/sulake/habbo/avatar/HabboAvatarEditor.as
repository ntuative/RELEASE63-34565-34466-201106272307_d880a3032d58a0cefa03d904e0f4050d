package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor
   {
      ...
      private static const const_679:int = 2;
       
      
      private var _instanceId:uint;
      
      private var var_517:HabboAvatarEditorManager;
      
      private var var_941:IFigureData;
      ...
      public function HabboAvatarEditor(param1:uint, param2:HabboAvatarEditorManager)
      {
         ...
         this.var_517 = param2;
         this.var_941 = this.var_517.avatarRenderManager.getFigureData(AvatarType.const_127);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            for each(_loc2_ in this.var_516)
            {
               _loc2_.dispose();
               _loc2_ = null;
            }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         this.var_614["null"] = new FigureData(this);
         this.var_614["null"] = new FigureData(this);
         var _loc2_:FigureData = this.var_614["null"];
         var _loc3_:FigureData = this.var_614["null"];
         _loc2_.loadAvatarData(const_1431,FigureData.const_93);
         _loc3_.loadAvatarData(const_1430,FigureData.FEMALE);
         this.var_117 = new Map();
         this.var_516 = new Map();
         this.var_117.add(AvatarEditorFigureCategory.const_794,new BodyModel(this));
         this.var_117.add(AvatarEditorFigureCategory.const_58,new HeadModel(this));
         this.var_117.add(AvatarEditorFigureCategory.const_252,new TorsoModel(this));
         this.var_117.add(AvatarEditorFigureCategory.const_929,new LegsModel(this));
         ...
         this.var_516.add(AvatarEditorSideCategory.const_110,new WardrobeModel(this));
         this.var_516.add(AvatarEditorSideCategory.const_654,new ClubPromoModel(this));
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         if(this.var_758 != param3)
         {
            this.var_758 = param3;
            _loc4_ = true;
         }
         var _loc5_:FigureData = this.var_614[param2];
         if(_loc5_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_941.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_941.getPalette(param1);
      }
      ...
      private function selectDefaultCategory(param1:Array) : void
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_794);
         }
      }
      ...
      {
         var _loc2_:ISideContentModel = this.var_516.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      {
         return this.var_614[this.var_1101];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         {
            this.var_1158.saveFigure(_loc1_,_loc2_);
         }
         else
         {
            _loc3_ = new UpdateFigureDataMessageComposer(_loc1_,_loc2_);
            this.var_517.communication.getHabboMainConnection(null).send(_loc3_);
            _loc3_.dispose();
            _loc3_ = null;
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1723;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_758 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < const_679)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1698.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_517.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_517.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            _loc15_ = Boolean(_loc14_.indexOf(param2) == -1);
            if(_loc15_)
            {
               _loc21_ = this.var_517.assets.getAssetByName("removeSelection") as BitmapDataAsset;
               if(_loc21_)
               {
                  _loc22_ = (_loc21_.content as BitmapData).clone();
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1407.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1769)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_758 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1407.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      {
         return this.var_517.configuration.getBoolean("avatareditor.allowclubtryout",false);
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_758 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_516.getValue(AvatarEditorSideCategory.const_110);
      }
