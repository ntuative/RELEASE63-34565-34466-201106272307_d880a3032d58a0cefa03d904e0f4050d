package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditorManager extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_938:AvatarEditorMessageHandler;
      ...
      public function close(param1:uint) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorInstanceId.const_213:
               _loc2_.hide();
               break;
            case AvatarEditorInstanceId.const_407:
               _loc2_.hide();
               _loc2_.dispose();
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_938 = new AvatarEditorMessageHandler(this,this._communication);
      }
