package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2372 = parseInt(param1.@precedence);
         this.var_2373 = String(param1.@activepartset);
         this.var_2369 = String(param1.@assetpartdefinition);
         this.var_2371 = String(param1.@lay);
         this.var_862 = String(param1.@geometrytype);
         this.var_2370 = Boolean(parseInt(param1.@main));
         this.var_2368 = Boolean(parseInt(param1.@method_7));
         this.var_2367 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2366 = _loc6_;
            }
            else
            {
               this.var_1766[_loc5_] = _loc6_;
            }
         }
         for each(_loc4_ in param1.type)
         {
            _loc7_ = String(_loc4_.@id);
            this.var_154[_loc7_] = new ActionType(_loc4_);
         }
      }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1766[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2366;
         }
         return _loc2_;
      }
      ...
      private function getTypePrevents(param1:String) : Array
      {
         ...
         var _loc2_:ActionType = this.var_154[param1];
         if(_loc2_ != null)
         {
