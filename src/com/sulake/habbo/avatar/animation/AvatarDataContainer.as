package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2519:uint;
      
      private var var_2518:uint;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_793 = new ColorTransform(this.var_1720,this.var_1721,this.var_1719,this._alphaMultiplier);
         this.var_1215 = this.generatePaletteMapForGrayscale(this.var_2518,this.var_2519);
      }
