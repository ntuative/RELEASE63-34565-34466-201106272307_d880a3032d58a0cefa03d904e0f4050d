package com.sulake.habbo.avatar.animation
{
   public class SpriteDataContainer implements ISpriteDataContainer
   {
      ...
      public function SpriteDataContainer(param1:IAnimation, param2:XML)
      {
         ...
         this.var_1849 = parseInt(param2.@ink);
         this.var_3014 = String(param2.@member);
         this.var_3013 = Boolean(parseInt(param2.@directions));
         this._dx = [];
         this.var_1684 = [];
         this.var_1683 = [];
         for each(_loc3_ in param2.direction)
         {
            ...
            this.var_1684[_loc4_] = parseInt(_loc3_.@dy);
            this.var_1683[_loc4_] = parseInt(_loc3_.@dz);
         }
      }
      ...
      {
         if(param1 < this.var_1684.length)
         {
            return this.var_1684[param1];
         }
         return 0;
      }
      ...
      {
         if(param1 < this.var_1683.length)
         {
            return this.var_1683[param1];
         }
         return 0;
      }
