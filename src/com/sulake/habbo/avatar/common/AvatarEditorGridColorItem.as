package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_945:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_989.width,this.var_989.height,true,0);
            _loc5_ = this.var_989.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_945.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_946.width,this.var_946.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_946,this.var_946.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(this.var_945)
            {
               switch(this.var_945.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_46:
                     _loc4_.style = HabboIconType.const_981;
                     _loc4_.visible = true;
               }
            }
            else
