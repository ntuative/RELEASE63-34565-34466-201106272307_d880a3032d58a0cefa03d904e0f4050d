package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridView
   {
      ...
      public function AvatarEditorGridView(param1:IAvatarEditorCategoryModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary)
      {
         ...
         if(this._view != null)
         {
            this.var_640 = this._view.findChildByName("part_thumbs") as IItemGridWindow;
      ...
      public function initFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:CategoryData = this.var_78.getCategoryData(this.var_1489);
         if(!_loc1_)
         {
            return;
         }
         ...
         for each(_loc2_ in _loc1_.parts)
         {
            if(_loc2_)
            {
               this.var_640.addGridItem(_loc2_.view);
      ...
      {
         var _loc3_:IWindow = this.var_640.getGridItemAt(param1);
         if(!_loc3_)
         {
            return;
         }
      ...
      private function partEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = this.var_640.getGridItemIndex(param1.window);
            this.var_78.selectPart(this.var_1489,_loc3_);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.const_43)
         {
            ...
            while(_loc7_ < this.const_679)
            {
               if(this.var_537.length > _loc7_)
               {
                  ...
                  if(_loc5_ > -1)
                  {
                     this.var_78.selectColor(this.var_1489,_loc5_,_loc7_);
                     return;
                  }
               }
               _loc7_++;
