package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         this.var_258 = new Array(param1.length);
         var _loc3_:int = 0;
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         this.deselectColorIndex(this.var_258[param2],param2);
         this.var_258[param2] = param1;
      ...
      public function getSelectedColorIds() : Array
      {
         var _loc7_:* = null;
         var _loc8_:* = null;
         if(!this.var_258 || this.var_258.length == 0)
         {
            return null;
         }
         ...
         while(_loc5_ < this.var_258.length)
         {
            ...
            {
               if(_loc7_.length > this.var_258[_loc5_])
               {
                  _loc8_ = _loc7_[this.var_258[_loc5_]] as AvatarEditorGridColorItem;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= this.var_258[param1])
         {
            return null;
         }
         return _loc2_[this.var_258[param1]] as AvatarEditorGridColorItem;
      }
