package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_712:String = "tab_boy";
      
      private const const_711:String = "tab_girl";
      ...
      override public function init() : void
      {
         ...
         if(!var_41)
         {
            ...
            var_41["null"] = new AvatarEditorGridView(var_78,FigureData.const_87,_windowManager,_assetLibrary);
         }
         else
         {
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_78.controller.gender)
         {
            case FigureData.const_93:
               activateTab(this.const_712);
               inactivateTab(this.const_711);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_711);
               inactivateTab(this.const_712);
         }
      }
