   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_41)
         {
            ...
            var_41["null"] = new AvatarEditorGridView(var_78,FigureData.const_207,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_78,FigureData.const_251,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_78,FigureData.const_275,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_78 && var_167 == "")
         {
            var_78.switchCategory(FigureData.const_207);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "tab_shoes":
                  ...
                  break;
               case "tab_belts":
                  this.switchCategory(FigureData.const_275);
            }
         }
