package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private static const const_696:uint = 1;
      ...
      private var var_1194:IRoomSession;
      ...
      private var var_317:ICatalogNavigator;
      
      private var var_109:Purse;
      
      private var var_103:RecyclerLogic;
      ...
      private var var_2460:GiftWrappingConfiguration;
      
      private var var_1193:ClubGiftController;
      
      private var var_532:ClubBuyController;
      ...
      private var var_1480:IDragAndDropDoneReceiver;
      ...
      private var var_635:RoomPreviewer;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            this.var_16.events.removeEventListener(RoomSessionEvent.const_73,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1892);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_372.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_532.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2459 = this.isNewItemsNotificationEnabled();
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_372.loadProductData(this);
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_156,this.onObjectPlaced);
         this.initializeRoomPreviewer();
      }
      ...
      {
         if(this._roomEngine != null && this.var_150 != null && this.var_150.getKey("catalog.furniture.animation","false") == "true")
         {
            if(this.var_635 == null)
            {
               this.var_635 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      {
         return this.var_150.getBoolean("toolbar.new_additions.notification.enabled",false);
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_317.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_150.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_150.getKey("link.format.credits","/credits");
      ...
      {
         return this.var_372.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_372.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_65)
         {
            _loc3_ = this.var_372.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_791.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(this.mainWindowVisible())
         {
            ...
            if(this.var_103 != null && this.getCurrentLayoutCode() == "recycler")
            {
               this.var_103.activate();
            }
         }
         else
         {
         ...
         this.setupInventoryForRecycler(this.var_103.active && this.mainWindowVisible());
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_317 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_696) as IWindowContainer;
         ...
         _loc3_.setParamFlag(WindowParam.const_286,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_73:
               this.var_1802 = param1.session.isPrivateRoom;
               this.var_1194 = param1.session;
               if(this.var_103 != null)
               {
                  this.var_103.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_83:
               ...
               if(this.var_103 != null)
               {
                  this.var_103.setRoomSessionActive(false);
               }
         }
      }
      ...
      {
         this.var_103 = new RecyclerLogic(this,this._windowManager);
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1193 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_532 == null)
         {
            this.var_532 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1479 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_317.buildCatalogIndex(_loc2_);
         if(this.var_792 && this.var_792 != "")
         {
            this.var_317.openPage(this.var_792);
            this.var_792 = "";
            this.var_969 = -1;
         }
         else if(this.var_969 > -1)
         {
            this.var_317.openPageById(this.var_969,this.var_1803);
            this.var_969 = -1;
            this.var_1803 = -1;
            this.var_792 = "";
         }
         else if(this.var_1479 && this.var_2459)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_317.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1996));
         }
         else
         {
            this.var_317.loadFrontPage();
         }
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2458 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1258);
         }
         this.var_2458 = false;
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_116,this.var_109.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2457 && this._soundManager != null)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_287,_loc2_.amount));
         }
         if(_loc2_.type == ActivityPointTypeEnum.const_968)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_263,_loc2_.amount));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_287,_loc2_.points["null"]));
         }
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_263,_loc2_.points["null"]));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_109.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1407 ? true : false;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1193.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_103 == null)
         {
            return;
         }
         this.var_103.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         this.var_103.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         this.var_103.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2460 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onHabboClubOffers(param1:HabboClubOffersMessageEvent) : void
      {
         if(this.var_532 != null)
         {
            this.var_532.onOffers(param1);
         }
      }
      
      private function onHabboClubExtendOffer(param1:HabboClubExtendOfferMessageEvent) : void
      {
         if(this.var_634 != null && this.var_150.getBoolean("club.membership.extend.promotion.enabled",false))
         {
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_791.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_791.add(_loc2_.productCode,_loc3_.slice());
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "true" == this.var_150.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_150.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_174)
         {
            _loc3_ = this.var_150.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(!this.var_150.keyExists("catalog.drag_and_drop") || this.var_150.getKey("catalog.drag_and_drop") != "true")
         {
            return false;
         }
         if(!this.var_1194 || !this.var_1194.isRoomOwner)
         {
            return false;
         }
         ...
         {
            case ProductTypeEnum.const_194:
               _loc3_ = false;
               break;
            case ProductTypeEnum.const_363:
               _loc3_ = false;
         }
         return _loc3_;
      }
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_204);
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_212);
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_203);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1192 && param1.type == RoomEngineObjectEvent.const_156)
         {
            ...
            this.var_62 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_790);
            _loc5_ = this.var_1480;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_378,0.5);
            }
         }
      }
            ...
            if(this.var_62.roomCategory == this._roomEngine.activeRoomCategory && this.var_62.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  case FurniCategory.const_353:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_212);
                  ...
                  case FurniCategory.const_369:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_204);
                  ...
                  case FurniCategory.const_347:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_203);
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_150.getKey("image.library.catalogue.url");
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_696);
            if(_loc1_ != null)
            {
      ...
      public function update(param1:uint) : void
      {
         if(this.var_635 != null)
         {
            this.var_635.updatePreviewRoomView();
         }
      }
   }
}
