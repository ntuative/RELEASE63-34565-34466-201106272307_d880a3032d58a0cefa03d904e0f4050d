   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowKeyboardEvent.const_344,this.onNameInputKeyUp);
         }
         ...
         if(_loc7_ != null)
         {
            ...
            _loc7_.addEventListener(WindowEvent.const_381,this.onMessageInputFocus);
         }
         this.var_1887 = true;
         this.var_1886 = true;
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               _loc12_.addEventListener(WindowEvent.const_332,this.onFreeWrappingSelected);
               _loc12_.addEventListener(WindowEvent.const_665,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_1888 = _loc1_.stuffTypes;
            this.var_830 = _loc1_.boxTypes;
            this.var_828 = _loc1_.ribbonTypes;
            this.var_1249 = this.var_1888[0];
            this.var_384 = this.var_830[0];
            this.var_385 = this.var_828[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_385 < 0)
         {
            this.var_385 = this.var_828.length - 1;
         }
         if(this.var_385 > this.var_828.length - 1)
         {
            this.var_385 = 0;
         }
         if(this.var_384 < 0)
         {
            this.var_384 = this.var_830.length - 1;
         }
         if(this.var_384 > this.var_830.length - 1)
         {
            this.var_384 = 0;
         }
         var _loc1_:int = this.var_830[this.var_384] * 1000 + this.var_828[this.var_385];
         if(this._window == null)
         {
            return;
         }
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_1888)
         {
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_830[this.var_384]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_828[this.var_385]);
         this._catalog.purchaseProductAsGift(this.var_1514,this.var_1250,this.var_1516,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1514,this.var_1250,this.var_1516);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         for each(_loc5_ in this.var_254)
         {
            ...
            if(_loc4_.length >= this.const_2351)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2599 = _loc2_.text;
      }
      ...
      {
         if(this.var_281 == null || !this.var_281.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_281.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_281 == null)
         {
            this.var_281 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_829 == null)
         {
            this.var_829 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_281 == null || this.var_829 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_281.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_829.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function onSuggestionsMouseOver(param1:WindowEvent) : void
      {
         ...
         var _loc3_:IItemListWindow = this.var_281.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc3_ == null)
         {
            return;
         }
