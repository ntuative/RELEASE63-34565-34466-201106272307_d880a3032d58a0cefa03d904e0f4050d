package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_622 != const_1046;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1757 != RecyclerStatusMessageEvent.const_1248;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_622 == const_468;
      }
      ...
      {
         this.var_622 = const_1045;
         this.var_125 = new Array(const_222);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1757)
         {
            case RecyclerStatusMessageEvent.const_1970:
               this.var_622 = const_468;
            ...
            case RecyclerStatusMessageEvent.const_1248:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1954:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1219:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1836:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_125.length < const_222)
         {
            return false;
         }
         var _loc1_:int = 0;
