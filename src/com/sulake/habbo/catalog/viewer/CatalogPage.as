package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_2060:String = "ctlg_";
       
      
      protected var var_2264:XML;
      ...
      private var var_590:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1351:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_590 = new EventDispatcher();
      ...
      {
         var _loc2_:String = const_2060 + param1;
         ...
         this.var_2264 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2264) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1756:
               if(this.var_1351 == null)
               {
                  this.var_1351 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_40.push(this.var_1351);
               }
               break;
            case CatalogWidgetEnum.const_1867:
               this.var_40.push(new ItemGroupCatalogWidget(param1,this._catalog.sessionDataManager));
               break;
            case CatalogWidgetEnum.const_1890:
            ...
            case CatalogWidgetEnum.const_1997:
               ...
               break;
            case CatalogWidgetEnum.const_1963:
            ...
            case CatalogWidgetEnum.const_1879:
               ...
               break;
            case CatalogWidgetEnum.const_1948:
               this.var_40.push(new RecyclerCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1919:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_590.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_590 != null)
         {
            return this.var_590.dispatchEvent(param1);
         }
         return false;
      }
