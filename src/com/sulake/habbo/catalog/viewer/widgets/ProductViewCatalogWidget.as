package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_554:IDisplayObjectWrapper;
      
      private var var_1905:Point;
      
      private var var_555:IItemGridWindow;
      
      private var var_1526:IScrollbarWindow;
      
      protected var var_2164:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1017 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1258 = _window.findChildByName("ctlg_description") as ITextWindow;
         ...
         if(this.var_198 != null)
         {
            ...
            this.var_554 = this.var_198.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_554 != null && _loc3_ != null)
            {
               this.var_198.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_554.width,this.var_554.height);
               if(_loc4_ != null)
               {
                  this.var_554.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_1905 = new Point(this.var_99.x,this.var_99.y);
         this.var_555 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1526 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(this.var_555 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_2164 = _loc1_.content as XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1017.text = _loc4_;
         this.var_1258.text = _loc5_;
         this.var_1017.height = this.var_1017.textHeight + 5;
         this.var_1258.y = this.var_1017.y + this.var_1017.height;
         this.var_1258.height = Math.max(130,this.var_1258.textHeight + 5);
         ...
         else
         {
            ...
            {
               case Offer.const_550:
                  _loc6_ = this._bundlePreview.clone();
                  if(this.var_555 != null)
                  {
                     this.var_555.visible = true;
                     _loc11_ = _loc2_.productContainer as BundleProductContainer;
                     _loc11_.populateItemGrid(this.var_555,this.var_1526,this.var_2164);
                     this.var_555.scrollV = 0;
                  }
                  if(this.var_198 != null)
                  {
                     this.var_198.visible = false;
               ...
               case Offer.const_394:
                  _loc9_ = _loc2_.productContainer.firstProduct;
                  if(this.var_198 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_78 || _loc9_.productType == ProductTypeEnum.const_65 || _loc9_.productType == ProductTypeEnum.const_194)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_78:
                        if(_loc8_ != null && this.var_554 != null)
                        {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_372,AvatarAction.const_499);
                                 _loc18_.appendAction(AvatarAction.const_364,_loc9_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2633)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2633 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_99 != null && true)
         {
            ...
            this.var_99.x = this.var_1905.x;
            this.var_99.y = this.var_1905.y;
            if(param3 != null)
            {
