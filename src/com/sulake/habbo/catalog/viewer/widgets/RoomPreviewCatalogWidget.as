   ...
   public class RoomPreviewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IDragAndDropDoneReceiver
   {
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25 && this.var_589 != null && this.var_589 == param2)
         {
            if(this.var_106)
            {
               (page.viewer.catalog as HabboCatalog).requestSelectedItemToMover(this,this.var_106);
               this.var_589 = null;
            }
         }
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_368 != null && this._imageStoreWindow != null)
         {
            this.setRoomImage(this.var_368,this._imageStoreWindow);
         }
      }
   }
}
