package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      private var var_436:IButtonWindow;
      ...
      {
         super(param1);
         this.var_436 = _window.findChildByName("listen") as IButtonWindow;
         this.var_1210 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         if(this.var_436 != null)
         {
            this.var_436.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
            this.var_436.disable();
         }
         this.var_1209 = _window.findChildByName("playPreviewContainer") as IWindowContainer;
      ...
      override public function dispose() : void
      {
         if(this.var_436 != null)
         {
            this.var_436.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
         }
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            this._soundManager.musicController.stop(HabboMusicPrioritiesEnum.const_232);
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            ...
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_232);
            this._soundManager.musicController.playSong(this.var_983,HabboMusicPrioritiesEnum.const_232,15,40,0.5,2);
         }
      }
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_1210.text = _loc8_;
            }
         }
         else if(this.var_1210 != null)
         {
            this.var_1210.text = "";
         }
         if(this.var_436 != null)
