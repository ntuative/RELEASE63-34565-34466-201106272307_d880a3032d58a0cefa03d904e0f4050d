package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1505:String = "default";
      ...
      private var var_1506:String = "1.1";
      
      private var var_999:Dictionary;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_999 = this.parseElements(_loc2_.floors.pattern);
         this.var_1224 = this.parseElements(_loc2_.walls.pattern);
         this.var_1222 = this.parseElements(_loc2_.landscapes.pattern);
         for each(_loc3_ in page.offers)
         {
            ...
            {
               case "floor":
                  for(_loc10_ in this.var_999)
                  {
                     _loc11_ = this.var_999[_loc10_];
                     if(this.var_656.indexOf(_loc10_) == -1)
                     {
                        this.var_656.push(_loc10_);
                        this.var_1225.push(_loc3_);
                     }
                  }
                  break;
               case "wallpaper":
         ...
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1505,this.var_1506,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1223[this.var_459];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1505);
               }
               break;
            ...
            case "ctlg_floor_color_prev":
               this.changeColor(const_117,-1);
               break;
            case "ctlg_floor_color_next":
               this.changeColor(const_117,1);
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1225[this.var_457];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this._landscapeOffers[this.var_455];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1506);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_656[this.var_457];
         var _loc3_:Array = this.var_999[_loc2_];
         ...
         var _loc4_:Offer = this.var_1225[this.var_457];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_814[this.var_459];
         var _loc6_:Array = this.var_1224[_loc5_];
         if(_loc6_ != null && this.var_456 >= 0)
         {
            _loc13_ = _loc6_[this.var_456];
            if(_loc13_ != null)
            {
               this.var_1505 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1223[this.var_459];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_813[this.var_455];
         var _loc9_:Array = this.var_1222[_loc8_];
         if(_loc9_ != null && this.var_458 >= 0)
         {
            _loc15_ = _loc9_[this.var_458];
            if(_loc15_ != null)
            {
               this.var_1506 = _loc15_;
            }
         }
         var _loc10_:Offer = this._landscapeOffers[this.var_455];
         if(_loc10_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_117:
               ...
               if(this.var_457 < 0)
               {
                  this.var_457 = this.var_656.length - 1;
               }
               if(this.var_457 >= this.var_656.length)
               {
                  this.var_457 = 0;
               }
               this.var_454 = 0;
               this.var_996 = 0;
               _loc5_ = this.var_656[this.var_457];
               _loc6_ = this.var_999[_loc5_];
               if(_loc6_ != null)
               {
                  this.var_996 = _loc6_.length;
               }
            ...
            case const_241:
               ...
               if(this.var_459 < 0)
               {
                  this.var_459 = this.var_814.length - 1;
               }
               if(this.var_459 == this.var_814.length)
               {
                  this.var_459 = 0;
               }
               this.var_456 = 0;
               this.var_998 = 0;
               _loc7_ = this.var_814[this.var_459];
               _loc8_ = this.var_1224[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_998 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_455 < 0)
               {
                  this.var_455 = this.var_813.length - 1;
               }
               if(this.var_455 >= this.var_813.length)
               {
                  this.var_455 = 0;
               }
               this.var_458 = 0;
               this.var_997 = 0;
               _loc9_ = this.var_813[this.var_455];
               _loc10_ = this.var_1222[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_997 = _loc10_.length;
               }
