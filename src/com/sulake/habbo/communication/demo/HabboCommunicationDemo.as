package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_599:IKeyExchange;
      
      private var var_1136:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_3029:PseudoRandom;
      ...
      private var var_264:HabboHotelView;
      
      private var var_1693:String = "";
      
      private const const_2090:String = "fuselogin";
      ...
      {
         if(param1 && !this.var_742)
         {
            this.var_742 = param1;
            this.var_67.initConnection(HabboConnectionType.const_279);
         }
      }
      ...
      {
         if(this.var_67 && this.var_163 && this.var_16 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         var _loc1_:Boolean = this.var_163.getBoolean("client.hotel_view.show_on_startup",true);
         this.var_264 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         var _loc2_:String = this.var_163.getKey("client.hotel_view.image");
         var _loc3_:String = this.var_163.getKey("image.library.url");
         if(_loc2_ != null && _loc3_ != null)
         {
            this.var_264.loadHotelViewImage(_loc3_ + _loc2_);
         }
         var _loc4_:* = this.var_163.getKey("use.sso.ticket") == "1";
         this.var_742 = this.var_163.getKey("sso.ticket",null);
         this.var_2189 = this.var_163.getKey("flash.client.url","");
         this.var_3028 = this.var_163.getKey("external.variables.txt","");
         if(this.var_264 == null)
         {
            this.var_264 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_948,this.onInitConnection);
            }
            else
            {
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_67.mode = HabboConnectionType.const_1195;
            }
         }
         this.var_67.initConnection(HabboConnectionType.const_279);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_990);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_3029 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_67.mode)
         {
            case HabboConnectionType.const_100:
               ...
               this.var_1693 = _loc4_;
               this.var_264.loadBannerImage(_loc7_ + "?token=" + this.var_1693,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1195:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1868:
               this.var_1136 = this.generateRandomHexString(30);
               this.var_599 = new DiffieHellman(new BigInteger(this.var_163.getKey("connection.development.prime"),16),new BigInteger(this.var_163.getKey("connection.development.generator"),16));
               this.var_599.init(this.var_1136);
               _loc8_ = this.var_599.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_599.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_599.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_3029);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_2189,this.var_3028));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2090,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_742 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_742);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1692)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_229);
         }
         if(param1.type == Event.CLOSE && !this.var_3030)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1693);
         ...
         this.var_599 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_599.init(_loc14_);
            _loc15_ = this.var_599.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_1136 = _loc14_;
            }
