package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_948:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_139.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_158,HabboWindowStyle.const_47,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_2090,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_139.habboConfiguration.getKey("use.sso","false") == "true")
               {
                  _loc8_.select();
               }
            }
         ...
         if(this.var_139.habboConfiguration && this.var_139.habboConfiguration.getKey("try.existing.session","false") == "true")
         {
            this.var_1640 = true;
            this._window.visible = false;
            this.windowEventProcessor(WindowEvent.allocate(WindowEvent.const_174,this._window,null,false));
         }
      }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_2090,"/");
         ...
         {
            dispatchEvent(new Event(const_948));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_161.removeEventListener(SSOTicket.const_425,this.onParsedTicketSuccess);
            this.var_161.removeEventListener(SSOTicket.const_355,this.onParsedTicketFailure);
            this.var_161 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_161.addEventListener(SSOTicket.const_425,this.onParsedTicketSuccess);
         this.var_161.addEventListener(SSOTicket.const_355,this.onParsedTicketFailure);
      }
