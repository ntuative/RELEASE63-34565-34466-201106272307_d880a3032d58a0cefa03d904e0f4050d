package com.sulake.habbo.communication.encryption
{
   ...
   public class RC4_R27 extends RC4 implements IEncryption
   {
      ...
      private static const const_1571:int = 52;
      ...
      private static const const_1108:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
       
      
      private var var_1971:IEncryption;
      
      private var var_2713:PseudoRandom;
      ...
      override public function encipher(param1:ByteArray, param2:Boolean = false) : ByteArray
      {
         ...
         if(this.var_1971 != null)
         {
            ...
            _loc6_ = this.var_2713.nextInt() % 5;
            ...
            _loc5_ = this.var_1971.encipher(_loc7_,true);
      ...
      override protected function method_12(param1:Array, param2:int, param3:int) : void
      {
         var _loc4_:* = 0;
         var _loc5_:* = 0;
         var _loc6_:int = 0;
