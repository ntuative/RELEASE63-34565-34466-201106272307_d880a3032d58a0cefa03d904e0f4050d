package com.sulake.habbo.communication.messages.incoming.handshake
{
   ...
   public class InitCryptoMessageEvent extends MessageEvent implements IMessageEvent
   {
      ...
      {
         return (this.var_10 as InitCryptoMessageParser).token;
      }
      
      public function get isServerEncrypted() : Boolean
      {
         return (this.var_10 as InitCryptoMessageParser).isServerEncrypted;
      }
      
      public function get isClientEncrypted() : Boolean
      {
         return (this.var_10 as InitCryptoMessageParser).isClientEncrypted;
      }
   }
}
