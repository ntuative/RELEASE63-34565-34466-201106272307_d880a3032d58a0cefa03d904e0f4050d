package com.sulake.habbo.communication.messages.incoming.notifications
{
   ...
   public class HabboActivityPointNotificationMessageEvent extends MessageEvent implements IMessageEvent
   {
      ...
      {
         return (var_10 as HabboActivityPointNotificationMessageParser).amount;
      }
      
      public function get change() : int
      {
         return (var_10 as HabboActivityPointNotificationMessageParser).change;
      }
      
      public function get type() : int
      {
         return (var_10 as HabboActivityPointNotificationMessageParser).type;
      }
   }
}
