package com.sulake.habbo.communication.messages.incoming.users
{
   ...
   public class HabboGroupDetailsMessageEvent extends MessageEvent implements IMessageEvent
   {
      ...
      {
         return (var_10 as HabboGroupDetailsMessageParser).groupId;
      }
      
      public function get name() : String
      {
         return (var_10 as HabboGroupDetailsMessageParser).name;
      }
      
      public function get description() : String
      {
         return (var_10 as HabboGroupDetailsMessageParser).description;
      }
      
      public function get roomId() : int
      {
         return (var_10 as HabboGroupDetailsMessageParser).roomId;
      }
      
      public function get roomName() : String
      {
         return (var_10 as HabboGroupDetailsMessageParser).roomName;
      }
   }
}
