package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_1073:Boolean = false;
      
      private static const const_699:String = "Navigation";
      
      private static const const_698:String = "Friend Bar";
      
      private static const const_1508:String = "go.friendbar";
      
      private static const const_1506:String = "chat_btn_click";
      
      private static const const_1505:String = "find_friends_btn_click";
      
      private static const const_1074:String = "Toolbar";
      
      private static const const_1071:String = "open";
      
      private static const const_1072:String = "close";
      ...
      private var var_980:IHabboConfigurationManager;
      ...
      private var var_639:IHabboEventStream;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_980)
            {
               this.var_980.release(new IIDHabboConfigurationManager());
               this.var_980 = null;
            }
            if(this.var_92)
            {
            ...
            if(this.var_84)
            {
               if(!this.var_84.disposed)
               {
                  ...
                  this.var_84.events.removeEventListener(FriendRequestEvent.const_206,this.onFriendRequestEvent);
               }
            ...
            if(this.var_639)
            {
               this.var_639.release(new IIDHabboEventStream());
               this.var_639 = null;
            }
            this.var_111 = null;
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_92)
         {
            ...
            this.var_92.getHabboMainConnection(null).send(new EventLogMessageComposer(const_699,const_698,const_1508));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_218)
         {
            ...
            if(this.var_92)
            {
               this.var_92.getHabboMainConnection(null).send(new EventLogMessageComposer(const_699,const_698,const_1506));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_92)
         {
            ...
            this.var_92.getHabboMainConnection(null).send(new EventLogMessageComposer(const_699,const_698,const_1505));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_84)
         {
            if(!this.var_84.disposed)
            {
               ...
               if(this.var_92)
               {
                  this.var_92.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1074,const_1507,!!this.var_84.isOpen() ? const_1071 : const_1072));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_218)
         {
            if(!this.var_218.disposed)
            {
               ...
               if(this.var_92)
               {
                  this.var_92.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1074,const_1509,!!this.var_218.isOpen() ? const_1071 : const_1072));
               }
            }
         }
      }
      ...
      public function toggleOfflineStream() : void
      {
         if(this.var_639)
         {
            if(!this.var_639.disposed)
            {
               this.var_639.visible = !this.var_639.visible;
            }
         }
      }
      ...
      {
         this.var_980 = param2 as IHabboConfigurationManager;
         this.var_2485 = this.var_980.getBoolean("friendbar.notifications.enabled",false);
         this.var_1826 = this.var_980.getBoolean("friendbar.requests.enabled",false);
      }
      ...
      {
         this.var_639 = param2 as IHabboEventStream;
      }
      ...
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_84.events.addEventListener(FriendRequestEvent.const_206,this.onFriendRequestEvent);
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_111 = !!const_318 ? this.sortByNameAndOnlineStatus(this.var_111) : this.sortByName(this.var_111);
         }
         events.dispatchEvent(new FriendBarUpdateEvent());
      }
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_801));
            this.makeNotification(String(this.var_801),FriendNotification.const_416,null,false,false);
         }
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_801));
            this.makeNotification(String(this.var_801),FriendNotification.const_416,null,true,false);
         }
      }
