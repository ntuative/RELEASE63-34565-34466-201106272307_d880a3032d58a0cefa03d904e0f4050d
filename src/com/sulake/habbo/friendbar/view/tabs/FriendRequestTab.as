package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestTab extends FriendEntityTab
   {
      ...
      protected static const const_2037:String = "friend_request_tab_xml";
      
      protected static const const_463:String = "bubble";
      
      protected static const const_1157:String = "message";
      
      protected static const const_2038:String = "button_accept";
      
      protected static const const_1411:String = "button_close";
      
      protected static const const_1029:String = "click_region_reject";
      ...
      private static var var_1466:FriendRequestTab;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:FriendRequestTab = !!var_1466 ? var_1466 : new FriendRequestTab();
      ...
      {
         var _loc6_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2037).content as XML) as IWindowContainer;
         ...
         var _loc7_:IRegionWindow = WINDOWING.create("ICON",WindowType.const_337,WindowStyle.const_103,WindowParam.const_31,new Rectangle(0,0,25,25)) as IRegionWindow;
         _loc7_.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = WINDOWING.create("BITMAP",WindowType.const_397,WindowStyle.const_103,WindowParam.const_33,new Rectangle(0,0,25,25)) as IBitmapWrapperWindow;
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case const_2038:
                  var_354.acceptFriendRequest(var_168.id);
                  break;
               case const_1411:
                  if(selected)
                  {
                  ...
                  break;
               case const_1029:
                  var_354.declineFriendRequest(var_168.id);
            }
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(param2.name == const_1029)
            {
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1029)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(REGION_REJECT_TEXT)).textColor = const_1488;
            }
         }
      }
