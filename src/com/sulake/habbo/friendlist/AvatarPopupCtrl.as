package com.sulake.habbo.friendlist
{
   ...
   public class AvatarPopupCtrl extends PopupCtrl
   {
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_1819 != "")
         {
            friendList.refreshText(param1,"name_text_online",this.var_880,this.var_1819);
         }
         else
         {
            friendList.refreshText(param1,"name_text_online",this.var_880,this.var_2036);
         }
         friendList.refreshText(param1,"name_text_offline",!this.var_880,this.var_2036);
         friendList.refreshText(param1,"motto_text",this.var_880,this.var_2814);
         friendList.refreshButton(param1,"offline",!this.var_880,null,0);
         if(this.var_880)
         {
            this.refreshFigure(param1,this.var_2815);
