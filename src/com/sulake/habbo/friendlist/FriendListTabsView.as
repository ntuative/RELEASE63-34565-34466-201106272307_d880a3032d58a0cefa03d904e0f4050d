package com.sulake.habbo.friendlist
{
   ...
   public class FriendListTabsView
   {
      ...
      public function refresh(param1:String) : void
      {
         ...
         this.var_197.width = this._friendList.tabs.tabContentWidth;
         this.var_197.findChildByName("bg").width = this._friendList.tabs.tabContentWidth;
         var _loc2_:int = 1;
         for each(_loc3_ in this._friendList.tabs.getTabs())
         {
            _loc4_ = this.var_197.getChildByName("flt_" + _loc3_.id) as IWindowContainer;
         ...
         this.var_197.height = _loc2_ + 1;
         this.var_197.findChildByName("bg").height = this.var_197.height;
      ...
      private function refreshTabText(param1:FriendListTab, param2:IWindowContainer) : void
      {
         ...
         _loc3_.textColor = this._friendList.laf.include(param1.newMessageArrived,param1.id);
      }
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            this._friendList.trackFriendListEvent(HabboFriendListTrackingEvent.const_604);
         }
      }
