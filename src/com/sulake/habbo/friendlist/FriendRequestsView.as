package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_2069:String = "no_reqs_info";
      ...
      private var var_1848:IContainerButtonWindow;
      
      private var var_1847:IContainerButtonWindow;
      ...
      {
         this.var_1848 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1847 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1847.procedure = this.onDismissAllButtonClick;
         this.var_1848.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_180)
         {
         ...
         else if(param1.state == FriendRequest.const_1259)
         {
      ...
      public function acceptAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_403 && _loc2_.state != FriendRequest.const_423)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1848,_loc1_);
         this.setEnabled(this.var_1847,_loc1_);
      }
