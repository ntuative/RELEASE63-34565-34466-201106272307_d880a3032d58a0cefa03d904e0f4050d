package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_608:IAvatarRenderManager;
      
      private var var_914:ISessionDataManager;
      
      private var var_2998:FriendListLookAndFeel;
      
      private var var_443:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_2168:OpenedToWebPopup;
      ...
      private var var_2167:AvatarSearchResults;
      ...
      {
         this.var_2998 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_117 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_2167 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_731.stop();
            this.var_731.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_731 = null;
         }
         ...
         if(this.var_914)
         {
            this.var_914.release(new IIDSessionDataManager());
            this.var_914 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_2168 = new OpenedToWebPopup(this);
         }
         this.var_2168.show(x,y);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_349,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_608.createAvatarImage(param1,AvatarScaleType.const_115,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_150.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_150.getKey(param1,param1,param2);
      }
      ...
      {
         this.var_1004 = param2 as IHabboNotifications;
      ...
      {
         this.var_914 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_117.addCategory(new FriendCategory(FriendCategory.const_1173,this.getText("friendlist.friends")));
         this.var_117.addCategory(new FriendCategory(FriendCategory.const_434,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_117.addFriend(new Friend(_loc4_));
         }
         this.var_443 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_731)
         {
            this.var_731 = new Timer(120000);
            this.var_731.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_731.start();
         }
         ...
         {
            _loc5_ = this.var_117.findCategory(FriendCategory.const_434);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_443.findTab(FriendListTab.const_90).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_443.findTab(FriendListTab.const_90);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_2167.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_443.findTab(FriendListTab.const_90);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_443.findTab(FriendListTab.const_90);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_914 || !this.var_118)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_914.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_46))
         {
            _loc2_ = this.var_118.vipLimit;
         }
         else if(this.var_914.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_38))
         {
