package com.sulake.habbo.friendlist
{
   ...
   public class PopupCtrl
   {
      ...
      public function showPopup(param1:IWindowContainer, param2:IWindow) : void
      {
         if(this.var_61 == null)
         {
            this.var_61 = IWindowContainer(this._friendList.getXmlWindow(this.var_1151));
         ...
         this.var_61.height = Util.method_1(this.var_61) + 10;
         var _loc3_:Point = new Point();
         var _loc4_:Point = new Point();
         param1.getGlobalPosition(_loc3_);
         param2.getGlobalPosition(_loc4_);
         this.var_61.x = _loc4_.x - _loc3_.x + this.var_2690 + param2.width;
