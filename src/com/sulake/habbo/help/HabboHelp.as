package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_1040:IHabboConfigurationManager;
      
      private var var_372:ISessionDataManager;
      
      private var var_1285:FaqIndex;
      ...
      private var var_856:HotelMergeUI;
      
      private var var_1568:CallForHelpData;
      
      private var var_2692:UserRegistry;
      
      private var var_2614:String = "";
      
      private var var_1041:WelcomeScreenController;
      
      public function HabboHelp(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1568 = new CallForHelpData();
         this.var_2692 = new UserRegistry();
         super(param1,param2,param3);
         this._assetLibrary = param3;
         this.var_1285 = new FaqIndex();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1040)
         {
            this.var_1040.release(new IIDHabboConfigurationManager());
            this.var_1040 = null;
         }
      ...
      public function getConfigurationKey(param1:String, param2:String = null, param3:Dictionary = null) : String
      {
         ...
         return this.var_1040.getKey(param1,param2,param3);
      }
      ...
      {
         this.var_1568.reportedUserId = param1;
         this.var_1568.reportedUserName = param2;
         this.var_75.showUI(HabboHelpViewEnum.const_420);
      }
      ...
      public function initHotelMergeUI() : void
      {
         if(!this.var_856)
         {
            this.var_856 = new HotelMergeUI(this);
         }
         this.var_856.startNameChange();
      }
      ...
      public function startNameChange() : void
      {
         if(this.var_119)
         {
            this.var_119.showView(TutorialUI.const_359);
         }
      }
      ...
      {
         this.var_1040 = IHabboConfigurationManager(param2);
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         if(!this.var_1041)
         {
            this.var_1041 = new WelcomeScreenController(this,this._windowManager);
         }
         this.var_1041.showWelcomeScreen(param1);
      }
