package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1907:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201106272301));
         this.var_131 = new Map();
         this.var_131.add(HabboHelpViewEnum.const_1937,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_131.add(HabboHelpViewEnum.const_228,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_131.add(HabboHelpViewEnum.const_521,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_131.add(HabboHelpViewEnum.const_339,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_131.add(HabboHelpViewEnum.const_297,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_131.add(HabboHelpViewEnum.const_420,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_131.add(HabboHelpViewEnum.const_870,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_131.add(HabboHelpViewEnum.const_267,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_131.add(HabboHelpViewEnum.const_1393,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_131.add(HabboHelpViewEnum.const_1338,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_131.add(HabboHelpViewEnum.const_850,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_131.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_131.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(param1 == this.var_1907)
         {
            this.var_556 = new Array();
         }
         else if(param2)
         {
            if(this.var_556.length == 0 || param1 != this.var_389)
            {
               this.var_556.push(this.var_389);
            }
         }
         this.var_389 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_267:
               ...
               break;
            case CallForHelpResultEnum.const_1280:
               this.showUI(HabboHelpViewEnum.const_1338);
               break;
            case CallForHelpResultEnum.const_1408:
               this.showUI(HabboHelpViewEnum.const_1393);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_131.getValue(HabboHelpViewEnum.const_228) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_619));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = this.var_131.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_131.getValue(this.var_389);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2515 = this._window.width - _loc3_.width;
         this.var_2516 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2516;
         this._window.width = _loc1_.width + this.var_2515;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_556.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_389 == HabboHelpViewEnum.const_228)
         {
            return;
         }
         if(this.var_665.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_665.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_665[1],this.var_665[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_665[0],this.var_665[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_389 == HabboHelpViewEnum.const_228 || this.var_556.length == 0)
         {
            return;
         }
         if(this.var_388 == null)
