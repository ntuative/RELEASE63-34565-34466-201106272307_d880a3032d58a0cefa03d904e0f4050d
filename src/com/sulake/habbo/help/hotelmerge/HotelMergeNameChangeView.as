package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_806)
         {
            this.var_806 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_806)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_807)
         {
            this.var_807 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_807)
            {
               return;
            }
