package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private var var_1840:IWindowContainer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1840 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_806)
         {
            this.var_806 = this.var_27.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_806)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_807)
         {
            this.var_807 = this.var_27.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_807)
            {
               return;
            }
         ...
         var _loc1_:ITextWindow = this.var_807.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_539;
         }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this.var_27.localization.registerParameter("help.tutorial.name.available","name",this.var_539);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         this.var_1212 = new NameSuggestionListRenderer(this.var_27);
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_539 = this.var_27.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this.var_27.changeName(this.var_539);
               break;
            ...
            case "header_button_close":
               this.var_27.showView(TutorialUI.const_99);
         }
      }
