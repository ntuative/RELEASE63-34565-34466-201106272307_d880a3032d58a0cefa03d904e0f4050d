package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2350:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            this.var_16.events.removeEventListener(RoomSessionEvent.const_73,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionEvent.const_83,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_591,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_63.getValue(InventoryCategory.const_76));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_63.getValue(InventorySubCategory.const_382));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_63.getValue(InventoryCategory.const_233));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_63.getValue(InventorySubCategory.const_1188));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_63.getValue(InventoryCategory.const_132));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_63.getValue(InventoryCategory.const_460) as MarketplaceModel;
      }
      ...
      {
         return this.var_109.clubIsExpiring;
      }
      ...
      public function setClubStatus(param1:int, param2:int, param3:Boolean, param4:Boolean, param5:Boolean) : void
      {
         ...
         this.var_109.clubIsExpiring = param5;
      ...
      {
         this.var_372 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_73,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionEvent.const_83,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionPropertyUpdateEvent.const_591,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_83:
               ...
               break;
            case RoomSessionPropertyUpdateEvent.const_591:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_372 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_16 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_63.add(InventoryCategory.const_460,_loc1_);
         ...
         this.var_63.add(InventoryCategory.const_76,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_372);
         this.var_63.add(InventoryCategory.const_233,_loc3_);
         ...
         this.var_63.add(InventorySubCategory.const_382,_loc5_);
         ...
         this.var_63.add(InventorySubCategory.const_1188,_loc6_);
         ...
         this.var_63.add(InventoryCategory.const_132,_loc7_);
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_1011.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_1011.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_1011.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_1011.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2350);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_296));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2570)
         {
            this.var_2570 = _loc1_;
