package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_2375:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_372 = param5;
         this.var_372.events.addEventListener(BadgeImageReadyEvent.const_214,this.onBadgeImageReady);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_372.events.removeEventListener(BadgeImageReadyEvent.const_214,this.onBadgeImageReady);
            this.var_372 = null;
         }
      }
      ...
      private function stopWearingBadge(param1:Badge) : void
      {
         ...
         {
            if(this.var_900[_loc2_] == param1)
            {
               this.var_900.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1358.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_722.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_372.getBadgeImage(param1);
            if(_loc10_)
            {
               this.var_259.unshift(_loc11_);
            }
            else
            {
               this.var_259.push(_loc11_);
            }
            if(param2)
            {
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_365);
         var _loc3_:int = 0;
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         while(_loc2_ < this.var_259.length)
         {
            _loc3_ = this.var_259[_loc2_] as Badge;
            if(_loc3_ != null)
            {
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_555);
         ...
         var _loc3_:Array = this.getBadges(const_365);
      ...
      {
         return this.getItemInIndex(param1,const_365);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_555);
      }
      ...
      {
         if(param1 == InventoryCategory.const_233 && this.var_27.isVisible)
         {
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_722.indexOf(_loc2_) == -1)
            {
               this.var_722.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_722 && this.var_722.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1240));
            this.var_722 = [];
