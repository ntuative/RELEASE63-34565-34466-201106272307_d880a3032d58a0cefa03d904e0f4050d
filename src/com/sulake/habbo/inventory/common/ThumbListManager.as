package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1637:IThumbListDataProvider;
      
      private var var_257:int;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_706 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_706.width;
         this.var_105 = this.var_706.height;
         this.var_1335 = param5;
         this.var_1098 = param6;
         this.var_257 = Math.floor(this.var_1335 / this._thumbWidth);
         this.var_30 = new BitmapData(this.var_1335,this.var_1098);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_707 = this.resolveRowCountFromList();
         if(this.var_707 == 0)
         {
            this.var_30 = new BitmapData(this.var_1335,this.var_1098);
            return;
         }
         this.var_30 = new BitmapData(Math.max(this.var_257 * this._thumbWidth,this.var_1335),Math.max(this.var_707 * this.var_105,this.var_1098),true,16777215);
         this.var_30.fillRect(this.var_30.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_707)
         {
            _loc4_ = 0;
            while(_loc4_ < this.var_257)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     this.var_30.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * this._thumbWidth,_loc3_ * this.var_105),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_257 && this.var_30.height < _loc3_.y * this.var_105)
         {
            _loc2_ = new BitmapData(this.var_30.width,this.var_30.height + this.var_105);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_257 - 1),this.var_105);
         _loc2_.copyPixels(this.var_30,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_257 - 1),0,this._thumbWidth,this.var_30.height);
         _loc2_.copyPixels(this.var_30,_loc4_,new Point(0,this.var_105),null,null,true);
         _loc4_ = new Rectangle(0,this.var_105,this._thumbWidth * (this.var_257 - 1),this.var_30.height - this.var_105);
         _loc2_.copyPixels(this.var_30,_loc4_,new Point(this._thumbWidth,this.var_105),null,null,true);
         this.var_30 = _loc2_;
      }
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1637.getDrawableList();
         }
      ...
      private function resolveRowCountFromList() : int
      {
         ...
         return int(Math.ceil(_loc1_.length / this.var_257));
      }
      ...
      {
         var _loc2_:Point = this.resolveGridLocationFromImage(param1);
         return int(_loc2_.y * this.var_257 + _loc2_.x);
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / this.var_257);
         var _loc3_:int = param1 % this.var_257;
         return new Point(_loc3_,_loc2_);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc11_:* = null;
         var _loc12_:* = null;
         if(param1.x >= this.var_257)
         {
            return;
         }
         if(param1.y >= this.var_707)
         {
            return;
         }
         var _loc4_:int = this.var_257 - param1.x - 1;
         ...
         if(param1.y < this.var_707 - 1)
         {
            _loc7_ = this.var_30.width - this._thumbWidth;
            _loc8_ = this.var_30.height - (param1.y + 1) * this.var_105;
            ...
            this.var_30.fillRect(new Rectangle(0,this.var_30.height - this.var_105,this.var_30.width,this.var_105),4294967295);
            _loc3_ = new Point(this.var_30.width - this._thumbWidth,_loc2_.y - this.var_105);
         ...
         if(_loc6_ > 0)
         {
            ...
            if(param1.x == this.var_257 - 1)
            {
               _loc11_ = new BitmapData(this.var_30.width,this.var_30.height - this.var_105);
               _loc2_ = new Rectangle(0,0,this.var_30.width,this.var_30.height - this.var_105);
               _loc11_.copyPixels(this.var_30,_loc2_,new Point(0,0),null,null,true);
               this.var_30 = _loc11_;
               --this.var_707;
            }
         }
         if(this.var_30.height < this.var_1098)
         {
            _loc12_ = new BitmapData(this.var_30.width,this.var_1098);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_706.width,this.var_706.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_706.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_706,this.var_706.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
