package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1711:int = 1000;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_498 = [];
         this.var_497 = [];
         this.var_736 = new Timer(const_1712,1);
         this.var_736.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_3016 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_156,this.onObjectPlaced);
               }
            ...
            {
               this.var_736.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_736.stop();
               this.var_736 = null;
            }
            if(this.var_235 != null)
            {
               this.var_235.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_235.stop();
               this.var_235 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_39)
            {
               ...
               {
                  this.var_1686 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1686;
            }
            else
            {
         ...
         this.var_27.setInventoryCategoryInit(InventoryCategory.const_76);
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_919 == null)
         {
            this.var_919 = this._windowManager.buildFromXML(this.var_3016) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_919.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_919.clone() as IWindowContainer;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_235 = new Timer(param1,1);
            this.var_235.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_235.start();
         }
         else
         {
      ...
      {
         if(param1 == InventoryCategory.const_76 && this.var_27.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_44:
                  ...
                  break;
               case const_299:
                  this.var_27.toggleInventoryPage(InventoryCategory.const_132);
            }
         }
      }
      ...
      {
         this.var_27.checkCategoryInitilization(InventoryCategory.const_460);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_737.add(const_39,new Array());
         this.var_737.add(const_44,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_39;
            _loc5_ = this.var_498.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_44;
            _loc5_ = this.var_497.indexOf(param1.ref) > -1;
         }
         ...
         else
         {
            ...
            for(; _loc10_ < _loc8_.length; _loc10_++)
            {
               ...
               if(_loc9_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_220)
                  {
                     _loc7_ = _loc9_;
                  }
      ...
      {
         return getTimer() < this.var_3015 + const_1711;
      }
      ...
      {
         return this.var_27.getSubCategoryViewId() == InventorySubCategory.const_382;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_353 || _loc3_.category == FurniCategory.const_369 || _loc3_.category == FurniCategory.const_347)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_737.getValue(param1);
      }
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_382:
               this.cancelFurniInMover();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_737.getValue(param1) as Array;
         if(_loc3_ != null)
         {
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_498.indexOf(_loc2_) == -1)
            {
               this.var_498.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_410:
               return this.var_498.length;
            case UnseenItemCategoryEnum.const_447:
               return this.var_497.length;
            default:
               return this.var_498.length + this.var_497.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         switch(param1)
         {
            case const_44:
               ...
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_447));
                  this.var_497 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
               break;
            case const_39:
               if(this.var_498 && this.var_498.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_410));
                  this.var_498 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }
