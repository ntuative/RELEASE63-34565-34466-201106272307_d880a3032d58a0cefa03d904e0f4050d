package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1554:int = 10275685;
      ...
      protected var var_751:BitmapData;
      
      protected var var_2817:int;
      ...
      private const const_2082:Number = 1;
      
      private const const_2083:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2647 = this._window.findChildByName("outline");
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2251 == FurniModelCategory.const_39)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1602));
         }
         else
         {
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2083;
               _loc1_.blend = this.const_2083;
            }
            else
            {
               this._window.blend = this.const_2082;
               _loc1_.blend = this.const_2082;
            }
         }
         this.var_1592.color = !!this.var_1583 ? uint(const_1554) : uint(const_1555);
         this.var_2647.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2252 && this.getRecyclableCount() > 0)
            {
