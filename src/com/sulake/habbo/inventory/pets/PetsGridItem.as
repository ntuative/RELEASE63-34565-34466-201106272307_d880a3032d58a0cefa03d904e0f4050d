package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_43:
               this.var_1651.setSelectedGridItem(this);
               this.var_1650 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1650 = false;
                  this.var_1651.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1592)
         {
            return;
         }
         this.var_1592.color = !!this.var_1533 ? uint(const_1554) : uint(const_1555);
         this.var_2647.visible = param1;
      }
