package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_1063:int = 1;
      
      private const const_1062:int = 2;
      ...
      {
         var _loc2_:PetsGridItem = this.var_582.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(this.var_582 == null || this.var_582.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_582.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_582.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_582.add(param1.id,_loc2_);
      ...
      public function updateState() : void
      {
         ...
         {
            _loc2_ = this.const_1063;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1062;
         }
         else
         {
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_78.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_410) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_78.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_447) > 0;
