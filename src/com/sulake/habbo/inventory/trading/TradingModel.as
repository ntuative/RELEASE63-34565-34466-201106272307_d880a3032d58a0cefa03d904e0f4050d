package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_1251 = false;
         this.var_1843 = param6;
         this.var_888 = true;
         this.state = const_217;
         this.var_58.setup(param1,param3,param4,param6);
         this.var_58.updateItemList(this.var_833);
         this.var_58.updateItemList(this.var_1520);
      ...
      public function close() : void
      {
         if(this.var_888)
         {
            if(this._state != const_230 && this._state != const_316)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_832 + " OTHER: " + this.var_1251);
         ...
         {
            case const_230:
               if(param1 == const_217 || param1 == const_316)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_58.alertPopup(TradingView.const_1205);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_833)
            {
               this.var_832 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1251 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_58.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_833)
            {
               this.var_58.alertPopup(TradingView.const_1239);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_282.length < const_1875)
         {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_220)
            {
