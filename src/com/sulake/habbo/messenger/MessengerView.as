package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_1510:ConversationView;
      ...
      {
         if(this.var_158.conversations.method_3.length < 1)
         {
            return;
         }
         if(this.var_17 == null)
      ...
      public function addMsgToView(param1:Conversation, param2:Message) : void
      {
         ...
         this.var_1510.addMessage(param2);
      }
      
      private function prepareContent() : void
      {
         this.var_17 = IFrameWindow(this.var_158.getXmlWindow("main_window"));
         ...
         this.var_1010 = new ConversationsTabView(this.var_158,this.var_17);
         this.var_1010.refresh();
         this.var_1009 = ITextFieldWindow(this.var_17.findChildByName("message_input"));
         this.var_1009.addEventListener(WindowKeyboardEvent.const_185,this.onMessageInput);
         this.var_1510 = new ConversationView(this.var_158,this.var_17);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_828,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1206,true);
         this.var_17.center();
      }
      ...
      private function onMessageInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc2_ = 120;
            _loc3_ = this.var_1009.text;
            if(_loc3_.length > _loc2_)
            {
               this.var_1009.text = _loc3_.substring(0,_loc2_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_1009.text;
         ...
         this.var_1009.text = "";
         this.var_158.conversations.addMessageAndUpdateView(new Message(Message.const_980,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
