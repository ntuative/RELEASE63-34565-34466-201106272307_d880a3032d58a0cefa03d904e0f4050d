package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2367:String = "my_issues";
      
      private const const_2365:String = "open_issues";
      
      private const const_2366:String = "picked_issues";
      
      private const const_2379:String = "closed_issues";
      ...
      private var var_1986:IIssueBrowserView;
      
      private var var_1987:IIssueBrowserView;
      
      private var var_1988:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_288 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_288.numTabItems)
            {
               _loc5_ = this.var_288.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_48,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_288 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_288 == null || this.var_288.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_288.selector.getSelectableByName("open_issues");
         this.var_288.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_395.view.width = this.var_288.container.width;
         this.var_395.view.height = this.var_288.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2367:
               if(this.var_1986 == null)
               {
                  this.var_1986 = new MyIssuesView(this.issueManager,this,this.var_288.container);
               }
               return this.var_1986;
            case this.const_2365:
               if(this.var_1987 == null)
               {
                  this.var_1987 = new OpenIssuesView(this.issueManager,this,this.var_288.container);
               }
               return this.var_1987;
            case this.const_2366:
               if(this.var_1988 == null)
               {
                  this.var_1988 = new PickedIssuesView(this.issueManager,this,this.var_288.container);
               }
