package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_893:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2882 = param2.pickerUserId;
         this.var_2881 = param2.pickerUserName;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1348 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1347;
         }
         if(this.var_893 == null || param1.timeStamp < this.var_893.timeStamp)
         {
            this.var_893 = param1;
         }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1348 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1347;
            }
            if(this.var_893 == _loc2_)
            {
               this.var_893 = null;
            }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_893;
         if(_loc2_ == null)
         {
