package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_580:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_580 = new UserInfoCtrl(this._window,this.var_76,_loc3_.message);
         this.var_1334 = new UserInfoCtrl(this._window,this.var_76,_loc3_.message);
         this.var_580.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1334.load(_loc4_,this.var_178.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_76 != null && this.var_76.issueManager != null && this.var_178 != null)
         {
            this.var_76.issueManager.removeHandler(this.var_178.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_76.issueManager.closeBundle(this.var_178.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_76.issueManager.closeBundle(this.var_178.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_76.issueManager.closeBundle(this.var_178.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_76.issueManager.releaseBundle(this.var_178.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_76.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_76,WindowTracker.const_1342,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_580 = new UserInfoCtrl(this._window,this.var_76,_loc3_.message);
            this.var_580.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
