package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1882:int = 2;
      
      public static const const_1342:int = 3;
      
      public static const const_934:int = 4;
      
      public static const const_1309:int = 5;
      
      public static const const_1874:int = 6;
      
      public static const const_1737:int = 7;
      
      public static const TYPE_ISSUEHANDLER:int = 8;
      
      public static const const_1959:int = 9;
      ...
      {
         var _loc2_:Dictionary = this.var_1829[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1829[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
