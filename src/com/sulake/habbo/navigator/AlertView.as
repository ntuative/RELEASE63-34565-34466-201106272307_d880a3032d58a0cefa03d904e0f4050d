package com.sulake.habbo.navigator
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_688:Dictionary = new Dictionary();
       
      
      private var _navigator:HabboNavigator;
      
      protected var var_312:IFrameWindow;
      ...
      {
         var _loc1_:AlertView = var_688[this.var_1151] as AlertView;
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
         this.var_312 = this.getAlertWindow();
         if(this._title != null)
         {
            this.var_312.caption = this._title;
         }
         this.setupAlertWindow(this.var_312);
         var _loc2_:Rectangle = Util.getLocationRelativeTo(this.var_312.desktop,this.var_312.width,this.var_312.height);
         this.var_312.x = _loc2_.x;
         this.var_312.y = _loc2_.y;
         var_688[this.var_1151] = this;
         this.var_312.activate();
      }
