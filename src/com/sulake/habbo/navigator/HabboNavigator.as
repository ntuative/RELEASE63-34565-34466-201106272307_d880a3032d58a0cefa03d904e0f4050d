package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_727:RoomInfoViewCtrl;
      
      private var var_1375:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_443:Tabs;
      ...
      private var var_1027:GuestRoomPasswordInput;
      
      private var var_329:GuestRoomDoorbell;
      
      private var var_1376:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2987 = new Array();
         ...
         this.var_727 = new RoomInfoViewCtrl(this);
         this.var_1375 = new RoomCreateViewCtrl(this);
         this.var_2558 = new RoomThumbnailRenderer(this);
         this.var_1027 = new GuestRoomPasswordInput(this);
         this.var_329 = new GuestRoomDoorbell(this);
         this.var_443 = new Tabs(this);
         this.var_1376 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_349,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_150.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_350.startSearch(Tabs.const_304,Tabs.const_535,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_350.startSearch(Tabs.const_292,Tabs.const_255);
         this.var_443.getTab(Tabs.const_292).tabPageDecorator.tabSelected();
      }
