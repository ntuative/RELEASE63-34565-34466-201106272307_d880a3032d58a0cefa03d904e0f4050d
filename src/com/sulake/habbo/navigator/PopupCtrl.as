package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         this.var_491.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_491)
         {
            this.var_491.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_491.reset();
            this.var_491 = null;
         }
         if(this.var_420)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_61 == null)
         {
            this.var_61 = IWindowContainer(this._navigator.getXmlWindow(this.var_1151));
            this.var_61.visible = false;
            this.var_61.setParamFlag(HabboWindowParam.const_45,true);
            this.var_61.procedure = this.onPopup;
         }
         Util.hideChildren(this.var_61);
         this.refreshContent(this.var_61);
         this.var_61.height = Util.method_1(this.var_61) + 5;
         var _loc2_:Point = new Point();
         param1.getGlobalPosition(_loc2_);
         this.var_61.x = _loc2_.x + this.var_2690 + param1.width;
