package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1248:TextFieldManager;
      
      private var var_46:Array;
      
      private var var_1247:RoomLayout;
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1247.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1876 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1876 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_197 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_64 = IItemListWindow(this.var_197.findChildByName("item_list"));
         ...
         var _loc3_:IWindow = this.var_197.findChildByTag("close");
         this.addMouseClickListener(_loc3_,this.onCancelButtonClick);
         this.var_1248 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_197.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_197.desktop,this.var_197.width,this.var_197.height);
         this.var_197.x = _loc4_.x;
         this.var_197.y = _loc4_.y;
      }
      
      public function refresh() : void
      {
         this.var_1248.goBackToInitialState();
         this.var_1248.input.textBackgroundColor = 4294967295;
         this.var_1247 = this.var_46[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_79,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1248.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_197.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_197.findChildByName("back_button"));
      }
      ...
      {
         var _loc2_:String = this.var_1248.getText();
         var _loc3_:String = "model_" + this.var_1247.name;
