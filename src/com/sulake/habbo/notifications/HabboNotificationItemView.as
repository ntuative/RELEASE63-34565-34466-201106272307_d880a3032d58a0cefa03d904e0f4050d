package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_509:int = 70;
      
      public static const const_1977:int = 4;
      
      private static const name_4:int = 0;
      
      private static const const_563:int = 1;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1812 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1812 = 15;
         }
         this.var_1811 = this._window.height;
         this.var_1483 = 4;
         this._blend = 0;
         this._state = name_4;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_563:
               ...
               _loc2_ = Number(this.var_1196) / Number(this.var_973["time_fade_in"]);
               if(this.var_1196 > int(this.var_973["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1069:
               ...
               if(this.var_1482 > int(this.var_973["time_display"]) && !this.var_1810)
               {
                  this.startFadeOut();
               }
               break;
            case const_1068:
               ...
               _loc3_ = 1 - Number(this.var_1197) / Number(this.var_973["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1197 > int(this.var_973["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1812;
         if(this._window.height < this.var_1811)
         {
            this._window.height = this.var_1811;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1977;
         this._window.y = this.var_1483;
      }
