package com.sulake.habbo.quest
{
   ...
   public class FriendlyTime
   {
      ...
      private static const const_1132:int = 60;
      
      private static const const_1131:int = 3600;
      
      private static const const_1663:int = 3 * const_1132;
      
      private static const const_1664:int = 3 * const_1131;
      ...
      public static function getFriendlyTime(param1:IHabboLocalizationManager, param2:int) : String
      {
         ...
         {
            return getLocalization(param1,"friendlytime.hours",Math.round(param2 / const_1131));
         }
         if(param2 > const_1663)
         {
            return getLocalization(param1,"friendlytime.minutes",Math.round(param2 / const_1132));
         }
