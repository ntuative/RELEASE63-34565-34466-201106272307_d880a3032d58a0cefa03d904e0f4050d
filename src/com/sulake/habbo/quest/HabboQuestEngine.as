package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1649:int = 800;
      
      private static const const_1651:int = 15;
      
      private static const const_1652:int = 300;
      ...
      private var var_1332:QuestController;
      
      private var var_1091:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1332 = new QuestController(this);
         this.var_1091 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1650);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_372.events.removeEventListener(BadgeImageReadyEvent.const_214,this.var_1091.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_372.events.addEventListener(BadgeImageReadyEvent.const_214,this.var_1091.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_1332.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_1091.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1332.questTracker.isVisible();
      }
      ...
      {
         this.var_1332.update(param1);
         this.var_1091.update(param1);
      }
