package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1648:int = 10;
      
      private static const const_1645:int = 30;
      ...
      private var var_604:IScrollbarWindow;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_886 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_886.toggle();
         this.var_2058 = false;
      }
      ...
      private function refresh(param1:Boolean) : void
      {
         ...
         while(true)
         {
            if(_loc2_ < this.var_1625.length)
            {
               this.refreshEntry(true,_loc2_,this.var_1625[_loc2_],param1);
            }
            else
            {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_604 = IScrollbarWindow(this._window.findChildByName("scroller"));
         this._window.center();
         this.var_64.spacing = const_1647;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1648;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1646;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1645;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_2058 && !this.var_2059)
            {
               this.var_2058 = false;
