package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureSoundMachineLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_522,RoomObjectFurnitureActionEvent.const_576,RoomObjectFurnitureActionEvent.const_598,RoomObjectFurnitureActionEvent.const_652];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != this.var_1388)
         {
            this.var_1388 = _loc3_;
            if(_loc3_ == 1)
            {
      ...
      private function requestInitialize() : void
      {
         ...
         this.var_1955 = true;
         var _loc1_:RoomObjectFurnitureActionEvent = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_652,object.getId(),object.getType());
