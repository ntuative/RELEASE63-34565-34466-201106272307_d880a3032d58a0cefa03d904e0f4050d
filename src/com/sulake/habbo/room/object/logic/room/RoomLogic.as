package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1728:int = 255;
      
      private var var_1440:uint = 16777215;
      
      private var var_1730:int = 255;
      
      private var var_1164:uint = 16777215;
      
      private var var_1729:int = 255;
      
      private var var_1163:int = 0;
      
      private var var_1727:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_588,RoomObjectMouseEvent.const_172];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1017,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_827,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_788,1);
         ...
         if(this.var_1439)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_1017,_loc3_.toString());
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1163)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1728;
            if(_loc2_ - this.var_1163 >= this.var_1727)
            {
               _loc3_ = this.var_1164;
               _loc4_ = this.var_1729;
               this.var_1163 = 0;
            }
            else
            {
               _loc7_ = this.var_1440 >> 16 & 255;
               _loc8_ = this.var_1440 >> 8 & 255;
               _loc9_ = this.var_1440 & 255;
               _loc10_ = this.var_1164 >> 16 & 255;
               _loc11_ = this.var_1164 >> 8 & 255;
               _loc12_ = this.var_1164 & 255;
               _loc13_ = (_loc2_ - this.var_1163) / this.var_1727;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1730 + (this.var_1729 - this.var_1730) * _loc13_;
               this._color = _loc3_;
               this.var_1728 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_827,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_853:
               param2.setString(RoomObjectVariableEnum.const_212,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_909:
               param2.setString(RoomObjectVariableEnum.const_204,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_945:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_620:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_312)
               {
                  _loc5_ = "null";
               }
               this.var_583.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_769:
               _loc4_ = this.var_583.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_583.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1339,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1384:
               param2.setNumber(RoomObjectVariableEnum.const_788,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1192:
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_730:
               param2.setNumber(RoomObjectVariableEnum.const_1370,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1387:
               param2.setNumber(RoomObjectVariableEnum.const_1234,param1.value);
         }
      }
      ...
      private function updateFloorHoles(param1:RoomObjectRoomFloorHoleUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomFloorHoleUpdateMessage.const_145:
               ...
               this.var_1439 = true;
               break;
            case RoomObjectRoomFloorHoleUpdateMessage.const_152:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1440 = this._color;
         this.var_1730 = this.var_1728;
         this.var_1164 = _loc3_;
         this.var_1729 = _loc4_;
         this.var_1163 = getTimer();
         this.var_1727 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1991,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1964,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1899,_loc21_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_256 || _loc12_ == RoomPlaneData.const_449)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
