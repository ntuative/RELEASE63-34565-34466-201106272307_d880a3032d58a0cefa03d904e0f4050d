package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_211,RoomObjectRoomAdEvent.const_380,RoomObjectRoomAdEvent.const_383];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_442,"");
         _loc2_.setString(RoomObjectVariableEnum.const_1021,"");
      ...
      {
         super.update(param1);
         if(this.var_1626 > 0 && param1 > this.var_1626)
         {
            this.adDelayTimeout();
            this.var_1626 = 0;
         }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1324:
                  _loc2_.setString(RoomObjectVariableEnum.const_442,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_1021,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_608,Number(true));
                  this.var_1626 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1229);
            }
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_672)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_1021);
            ...
            case MouseEvent.ROLL_OVER:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_672)
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_380,_loc5_,_loc6_));
               }
               break;
            case MouseEvent.ROLL_OUT:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_672)
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_383,_loc5_,_loc6_));
               }
         }
      }
   }
