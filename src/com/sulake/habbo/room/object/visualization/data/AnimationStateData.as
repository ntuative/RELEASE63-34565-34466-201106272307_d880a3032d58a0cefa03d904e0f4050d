   ...
   public class AnimationStateData
   {
      ...
      public function resetAnimationFrames(param1:Boolean = true) : void
      {
         ...
         while(_loc2_ < this.var_646)
         {
            ...
            this.var_985[_loc2_] = false;
            this.var_984[_loc2_] = false;
            _loc2_++;
         }
      }
      ...
      {
         if(param1 >= 0 && param1 < this.var_646)
         {
