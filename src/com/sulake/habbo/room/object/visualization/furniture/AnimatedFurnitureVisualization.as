package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      protected function getAnimationId(param1:AnimationStateData) : int
      {
         ...
         if(_loc2_ != const_1225 && this._animationData.hasAnimation(this.var_452,_loc2_))
         {
            return _loc2_;
         }
         return const_1225;
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc5_ = _loc3_.getNumber(RoomObjectVariableEnum.const_776);
                  ...
                  _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_931);
                  if(!isNaN(_loc4_))
                  {
                     _loc6_ = this._animationData.getAnimationId(this.var_452,_loc4_);
      ...
      protected function setSubAnimation(param1:AnimationStateData, param2:int, param3:Boolean = true) : Boolean
      {
         ...
         if(param3)
         {
            ...
            if(param2 != _loc5_)
            {
               if(!this._animationData.isImmediateChange(this.var_452,param2,_loc5_))
               {
                  _loc6_ = AnimationData.getTransitionFromAnimationId(_loc5_);
                  if(this._animationData.hasAnimation(this.var_452,_loc6_))
                  {
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_129 != null)
         {
            this.var_129.setLayerCount(this.var_646);
         }
      }
      ...
      {
         var _loc2_:int = 0;
         if(!this.var_129.animationOver || this.var_993)
         {
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(!_loc9_ || this.var_993)
            {
               ...
               if(this.var_993 || _loc11_ == null || _loc11_.remainingFrameRepeats >= 0 && _loc13_ <= 0)
               {
                  ...
                  if(_loc12_ == AnimationFrame.const_1406)
                  {
               ...
               if(_loc11_ == null || _loc11_.remainingFrameRepeats == AnimationFrame.const_574)
               {
                  _loc10_ = true;
                  _loc9_ = true;
               }
