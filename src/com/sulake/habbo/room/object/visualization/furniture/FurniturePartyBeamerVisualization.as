package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function getNewPoint(param1:Number, param2:int) : Point
      {
         ...
         var _loc4_:int = this.var_1238[param2];
         var _loc5_:int = this.var_1239[param2];
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1238.push(1);
         this.var_1238.push(-1);
         this.var_1239 = new Array();
         this.var_1239.push(const_1539);
         this.var_1239.push(const_1540);
