package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1550:int = 0;
      
      private static const const_1551:int = 1;
      
      private static const const_1547:int = 2;
      
      private static const const_1548:int = 3;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  this.var_1704 = _loc4_.getNumber(RoomObjectVariableEnum.const_638);
                  this.var_1703 = _loc4_.getNumber(RoomObjectVariableEnum.const_573);
                  this._paramOffsetZ = _loc4_.getNumber(RoomObjectVariableEnum.const_556);
               }
            }
         }
         if(!this.var_1416)
         {
            this.var_1416 = this.checkIfImageReady();
            if(this.var_1416)
            {
               this.checkAndCreateImageForCurrentState(param1);
               return true;
      ...
      protected function checkIfImageChanged() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               _loc3_ = _loc2_.getString(RoomObjectVariableEnum.const_366);
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc2_.getNumber(RoomObjectVariableEnum.const_616);
                     if(_loc4_ == 1)
                     {
