package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_2036:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2391:Number = NaN;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1458 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1458;
            this.var_1458 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               if(param2 != this.var_1457)
               {
                  ...
                  _loc4_.color = this.getSpriteColor(param1,param2,this.var_2392);
               ...
               _loc4_.clickHandling = this.var_2324;
            }
            else
            {
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_514 != _loc3_.getUpdateID() || param1 != var_102 || param2 != this.var_2391)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2392 = _loc3_.getNumber(RoomObjectVariableEnum.const_271);
            ...
            this.var_1179 = this.getAdClickUrl(_loc3_);
            if(this.var_1179 == null || this.var_1179.indexOf("http") != 0)
            {
               this.var_1179 = null;
            }
            this.var_2324 = this.var_1179 != null;
            this.var_2396 = _loc3_.getNumber(RoomObjectVariableEnum.const_814);
      ...
      {
         if(this.var_2394 != param2 || this.var_2395 != param1)
         {
            this.var_956 = [];
            this.var_957 = [];
            this.var_772 = [];
            ...
            this.var_2393 = this.getSize(param1);
      ...
      {
         this.var_646 = param1;
         this.var_1457 = this.var_646 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_627.length)
         {
            return "";
         }
         var _loc3_:String = this.var_956[param2];
         var _loc4_:Boolean = this.var_957[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2393;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1457)
            {
               _loc6_ = FurnitureVisualizationData.const_627[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_956[param2] = _loc3_;
            this.var_957[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_768[param3] != null && !this.var_1771)
         {
            return this.var_768[param3];
         }
         if(this._data == null)
         {
            return LayerData.const_507;
         }
      ...
      {
         if(this.var_770[param2] != null)
         {
            return this.var_770[param2];
         }
         if(this._data == null)
         {
      ...
      protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         return Math.ceil(this.var_2396 * (param1 / 2));
      }
