package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1656:String = "head";
      
      private static const const_721:int = 1;
      
      private static const const_1129:int = 1000;
      
      private static const const_1658:String = "pet_experience_bubble_png";
      
      private static const const_1657:int = 0;
      
      private static const const_1659:int = 1;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1658) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_416 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_249);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_157);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_249);
            if(!isNaN(_loc6_))
            {
            ...
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_157);
            if(!isNaN(_loc7_))
            {
            ...
            this.var_1968 = _loc3_.getNumber(RoomObjectVariableEnum.const_300) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_231);
            if(!isNaN(_loc8_))
            {
               this.var_2101 = _loc8_;
            }
            else
            {
               this.var_2101 = direction;
            }
            this.var_1547 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2593 = _loc3_.getNumber(RoomObjectVariableEnum.const_431);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_807);
            if(_loc9_ != this.var_2100)
            {
               this.var_2100 = _loc9_;
               this.var_2862 = this.var_2100.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_416 != null)
         {
            ...
            if(this.var_1547 > 0)
            {
               ...
               if(_loc2_ < const_1129)
               {
                  this.var_416.alpha = int(Math.sin(_loc2_ / const_1129 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_416.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_416.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param1 != this.var_286)
         {
            ...
            this.setAnimationForIndex(const_1657,_loc3_);
         }
         if(param2 != this.var_1546)
         {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2862);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_721)
         {
            ...
            {
               if(param2 >= FurnitureVisualizationData.const_627.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_627[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2101);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_102,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1656)
            {
               this.var_1102[param1] = true;
            }
            else
            {
               this.var_1102[param1] = false;
            }
         }
