package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_1190:Vector3d = null;
      ...
      private var var_966:IPlaneRasterizer = null;
      
      private var var_783:PlaneMaskManager = null;
      
      private var _id:String = null;
      
      private var var_2451:Number = 0;
      ...
      private var var_234:Number = 0.0;
      ...
      {
         return this._isVisible && this.var_787;
      }
      ...
      public function copyBitmapData(param1:BitmapData) : BitmapData
      {
         if(this.visible)
         {
            if(this._bitmapData != null && param1 != null)
            {
               ...
               {
                  param1.copyPixels(this._bitmapData,this._bitmapData.rect,const_695);
                  return param1;
               }
            }
         }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_966.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_787 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_370))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_966 != null)
            {
               _loc3_ = this.var_966.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1797,this.var_2451,this.var_2450,this.var_2448,this.var_2446,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(!geometryChanged || !this.var_787)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1476.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1476[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1190);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_170.z - originZ,this.var_127.z - originZ,this.var_97.z - originZ,this.var_128.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2449 = relativeDepth;
            this._isVisible = true;
            this.var_1779 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            if(this._bitmapData == null || this.var_234 != this._bitmapData.width || this._height != this._bitmapData.height)
            {
               if(this._bitmapData != null)
               {
                  this._bitmapData.dispose();
                  this._bitmapData = null;
                  if(this.var_234 < 1 || this._height < 1)
                  {
                     return true;
                  }
               }
               else if(this.var_234 < 1 || this._height < 1)
               {
                  return false;
               }
               try
               {
                  this._bitmapData = new BitmapData(this.var_234,this._height,true,16777215);
               }
               catch(e:Error)
               {
                  _bitmapData = null;
            ...
            Randomizer.setSeed(this.var_2447);
      ...
      {
         this.var_170.assign(param1.getScreenPosition(this.var_104));
         this.var_127.assign(param1.getScreenPosition(Vector3d.sum(this.var_104,this.var_339)));
         this.var_97.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(this.var_104,this.var_340),this.var_339)));
         this.var_128.assign(param1.getScreenPosition(Vector3d.sum(this.var_104,this.var_340)));
         this._offset = param1.getScreenPoint(this.var_1190);
         ...
         var _loc2_:Number = Math.min(this.var_170.x,this.var_127.x,this.var_97.x,this.var_128.x);
         var _loc3_:Number = Math.max(this.var_170.x,this.var_127.x,this.var_97.x,this.var_128.x);
         var _loc4_:Number = Math.min(this.var_170.y,this.var_127.y,this.var_97.y,this.var_128.y);
         var _loc5_:Number = Math.max(this.var_170.y,this.var_127.y,this.var_97.y,this.var_128.y);
         _loc3_ -= _loc2_;
      ...
      {
         if(this.var_170 == null || this.var_127 == null || this.var_97 == null || this.var_128 == null || param2 == null || this._bitmapData == null)
         {
            return;
         }
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_967)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_371.length)
            {
               _loc5_ = this.var_371[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_273.length == this.var_968.length)
         {
         ...
         if(this.var_371.length > this.var_1477.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_967 || this.var_273.length == 0 && this.var_371.length == 0 && !this.var_370 || this.var_783 == null)
         {
            return;
         }
         ...
         if(this.var_370)
         {
            ...
            while(_loc5_ < this.var_273.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_80.width - this.var_80.width * _loc3_.leftSideLoc / this.var_340.length;
                  _loc11_ = this.var_80.height - this.var_80.height * _loc3_.rightSideLoc / this.var_339.length;
                  _loc12_ = _loc3_.type;
                  this.var_783.updateMask(this.var_80,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
            ...
            while(_loc6_ < this.var_371.length)
            {
               _loc4_ = this.var_371[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_80.width - this.var_80.width * _loc4_.leftSideLoc / this.var_340.length;
                  _loc11_ = this.var_80.height - this.var_80.height * _loc4_.rightSideLoc / this.var_339.length;
                  _loc13_ = this.var_80.width * _loc4_.leftSideLength / this.var_340.length;
                  _loc14_ = this.var_80.height * _loc4_.rightSideLength / this.var_339.length;
                  this.var_80.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1477.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_370 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_242.copyChannel(param1,param1.rect,const_695,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_242.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_242,this.var_242.rect,const_695,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
