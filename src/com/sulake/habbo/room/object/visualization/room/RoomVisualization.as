package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1931:int = 16777215;
      
      public static const const_1981:int = 13421772;
      
      private static const const_1127:int = 16777215;
      
      private static const const_1125:int = 13421772;
      ...
      public static const const_1818:int = 13421772;
      
      public static const const_2003:int = 10066329;
      ...
      private var var_583:RoomPlaneBitmapMaskParser = null;
      
      private var var_1505:String = null;
      
      private var _floorType:String = null;
      
      private var var_1506:String = null;
      
      private var var_1133:Number = NaN;
      
      private var var_1641:Number = NaN;
      
      private var var_2856:Number = NaN;
      
      private var var_2091:String = null;
      
      private var var_1337:uint = 16777215;
      
      private var var_2859:int = 255;
      
      private var var_2857:int = 255;
      
      private var var_2858:int = 255;
      ...
      private const const_2372:int = 250;
      
      private var var_1779:int = -1;
      
      private var var_1600:Number = 0.0;
      
      private var var_2790:Number = 0.0;
      
      private var var_2792:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_583 = new RoomPlaneBitmapMaskParser();
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1133))
         {
            this._planeParser.floorThicknessMultiplier = this.var_1133;
         }
         if(!isNaN(this.var_1641))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1641;
         }
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1354);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_256)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_449)
            {
               ...
               {
                  _loc13_.color = const_1818;
               }
               else
               {
                  _loc13_.color = const_2003;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1960)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_71,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_449)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this._lastUpdateTime + this.const_2372 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_413.length)
            {
               _loc11_ = this.var_709[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_413[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_2090)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2858 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2857 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2859 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1779)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1600 || _loc3_.y != this.var_2790 || _loc3_.z != this.var_2792 || param1.scale != this.var_2092))
            {
               this.var_1600 = _loc3_.x;
               this.var_2790 = _loc3_.y;
               this.var_2792 = _loc3_.z;
               this.var_2092 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1339);
            if(_loc3_ != this.var_2091)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2091 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_827));
            if(_loc4_ != this.var_1337)
            {
               this.var_1337 = _loc4_;
               this.var_2858 = this.var_1337 & 255;
               this.var_2857 = this.var_1337 >> 8 & 255;
               this.var_2859 = this.var_1337 >> 16 & 255;
               _loc2_ = true;
            }
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_204);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_212);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_203);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_788));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_935));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1022));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1370);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1234);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_1133 || _loc3_ != this.var_1641))
            {
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            ...
            if(!isNaN(_loc2_) && _loc2_ != this.var_2856)
            {
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_413;
         if(this.var_413.length == 0)
         {
            _loc6_ = this.var_162;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_413.length > 0;
         var _loc9_:int = 0;
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_413.push(_loc12_);
                        this.var_709.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1338;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_583.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_583.maskCount)
         {
            _loc10_ = this.var_583.getMaskType(_loc8_);
            _loc11_ = this.var_583.getMaskLocation(_loc8_);
            _loc12_ = this.var_583.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_71 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_312)
                              {
