package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1679:int = 2;
      ...
      private var var_2171:TriggerConfs;
      
      private var var_2169:ActionTypes;
      
      private var var_2170:ConditionTypes;
      
      private var var_307:Dictionary;
      
      private var var_38:Triggerable;
      
      private var var_917:RoomObjectHightLighter;
      
      private var var_193:UserDefinedRoomEventsHelp;
      
      private var var_1386:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_2171 = new TriggerConfs();
         this.var_2169 = new ActionTypes();
         this.var_2170 = new ConditionTypes();
         this.var_307 = new Dictionary();
         super();
         this.var_94 = param1;
         this.var_917 = new RoomObjectHightLighter(param1);
         this.var_193 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_307[param1])
         {
            delete this.var_307[param1];
            this.var_917.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_38.furniLimit)
         {
            this.var_307[param1] = param2;
            this.var_917.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1386 = new SliderWindowController(this.var_94,IWindowContainer(this.find(this.var_57,"delay_slider_container")),this.var_94.assets,0,20,1);
         this.var_1386.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1386.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_917.hideAll(this.var_307);
         }
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1386.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_193.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = this.var_38.stuffTypeSelectionCode < 1 ? int(var_1679) : int(this.var_38.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = (this.var_38.stuffTypeSelectionCode + 1) % (var_1679 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_2171);
         this.refreshConfigureElement(this.var_2169);
         this.refreshConfigureElement(this.var_2170);
         this._window.content.height = Util.method_1(this._window.content);
      ...
      private function refreshConfigureElement(param1:ElementTypeHolder) : void
      {
         ...
         this.var_57.height = Util.method_1(this.var_57) + 1;
      }
      ...
      private function refreshHeader(param1:Element, param2:String) : void
      {
         ...
         _loc3_.height = Util.method_1(_loc3_) + 4;
      }
