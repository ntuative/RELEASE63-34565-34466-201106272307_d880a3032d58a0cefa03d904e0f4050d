package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_2155:IWindowContainer;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_2155 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1371 = this.var_2155.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1371)
         {
            this.var_1371.procedure = this.onButtonClick;
         }
         this.var_1372 = this.var_2155.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1372)
         {
            this.var_1372.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_303 >= this.var_77.length - 1)
         {
            this.var_1372.disable();
         }
         else
         {
            this.var_1372.enable();
         }
         if(this.var_303 <= 0)
         {
            this.var_1371.disable();
         }
         else
         {
            this.var_1371.enable();
         }
      }
      ...
      {
         ++this.var_303;
         this.var_303 = Math.min(this.var_303,this.var_77.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_303;
         this.var_303 = Math.max(this.var_303,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_77[this.var_303][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_77[this.var_303][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_77[this.var_303][1]).value;
