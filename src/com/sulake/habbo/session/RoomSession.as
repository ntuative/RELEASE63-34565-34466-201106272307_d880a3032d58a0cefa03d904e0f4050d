package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_2378:int = 2500;
      ...
      private var var_1405:UserDataManager;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_1405 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_1405.connection = param1;
         }
      }
      ...
      public function start() : Boolean
      {
         ...
         {
            this._state = RoomSessionEvent.const_73;
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1697));
         this.var_1696.add(this.var_1697,getTimer());
         ++this.var_1697;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1696.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_2378)
            {
      ...
      {
         return this.var_1405 as IUserDataManager;
      }
