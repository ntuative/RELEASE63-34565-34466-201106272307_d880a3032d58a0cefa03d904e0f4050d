   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_243)
         {
            ...
            {
               _loc1_ = this.var_243.getKey(0) as String;
               _loc2_ = this.var_243.remove(_loc1_) as RoomSession;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1799)
         {
            this.gotoRoom(this.var_2454,this.var_2456,this.var_1800);
            this.var_1799 = false;
            this.var_1800 = "";
         }
      }
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         this.var_243.add(_loc6_,_loc7_);
      ...
      {
         if(param1.state == RoomSessionEvent.const_73)
         {
            return false;
         }
         if(param1.start())
         {
            this.var_1478 = false;
            events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_73,param1));
      ...
      public function sessionUpdate(param1:int, param2:int, param3:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               case RoomSessionHandler.const_1318:
                  break;
               case RoomSessionHandler.const_1293:
                  break;
               case RoomSessionHandler.const_743:
      ...
      public function sessionReinitialize(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc6_:RoomSession = this.var_243.remove(_loc5_) as RoomSession;
         if(_loc6_ != null)
         {
            param4 = param2;
            _loc6_.reset(param3,param4);
            _loc5_ = this.getRoomIdentifier(param3,param4);
            _loc7_ = this.var_243.remove(_loc5_);
            if(_loc7_ != null)
            {
            }
            this.var_243.add(_loc5_,_loc6_);
      ...
      public function getSession(param1:int, param2:int) : IRoomSession
      {
         ...
         return this.var_243.getValue(_loc3_) as IRoomSession;
      }
      
      public function disposeSession(param1:int, param2:int) : void
      {
         var _loc3_:String = this.getRoomIdentifier(param1,param2);
         var _loc4_:RoomSession = this.var_243.remove(_loc3_) as RoomSession;
         if(_loc4_ != null)
         {
