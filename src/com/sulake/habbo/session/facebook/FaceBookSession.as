package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1155:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1695:String = "sendAccessTokenToServer";
      
      private static const const_1694:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1695,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1694,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1155);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1155);
         }
      }
