package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1492:Point = new Point(3,3);
      
      private static const const_1581:uint = 7433577;
      
      private static const const_1583:uint = 5723213;
      
      private static const const_479:String = "_hover";
      
      private static const const_481:String = "_normal";
      
      private static const const_480:int = 5;
      
      private static const const_1582:int = 600;
      
      private static const const_1585:int = 80;
      
      private static const const_1584:int = 74;
      
      private static const ICON_SPACING_NORMAL:int = 10;
      
      private static const const_1580:int = -2;
      
      private static const const_1586:int = 5;
      
      private static const const_1587:int = 10;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1492;
         this._window.addEventListener(WindowEvent.const_549,this.onParentResized);
         ...
         this.var_224 = param2.buildFromXML(_loc12_.content as XML,2) as IWindowContainer;
         ...
         _loc13_.addChild(this.var_224);
         var _loc14_:ITextWindow = this.var_224.findChildByName("new_textfield") as ITextWindow;
         ...
         this.var_224.x = _loc13_.width - this.var_224.width - const_480;
         this.var_224.y = const_480;
         this.var_2737 = this.isNewItemsNotificationEnabled();
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         var _loc2_:* = this._windowManager.getDesktop(2).height < const_1582;
         if(!param1 && _loc2_ == this.var_1582)
         {
            return;
         }
         this.var_1582 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1584) : int(const_1585);
         var _loc4_:int = !!_loc2_ ? int(const_1580) : int(ICON_SPACING_NORMAL);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1586 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
         this._window.height = _loc6_.rectangle.bottom + const_1587;
      }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_224 != null && this.var_2737)
               {
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_775:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_801:
               _loc3_ = true;
         }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_479 ? this.var_1581 : this.var_1580;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_479)
         {
            param1.color = const_1581;
         }
         else
         {
            param1.color = const_1583;
         }
      }
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1582 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1582 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         if(this.var_1580)
         {
            this.var_1580.dispose();
         }
         this.var_1580 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1581)
         {
            this.var_1581.dispose();
         }
         this.var_1581 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1052.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_480;
            _loc2_.y = const_480;
            this.var_1052.add(param1,_loc2_);
         }
         return _loc2_;
      }
