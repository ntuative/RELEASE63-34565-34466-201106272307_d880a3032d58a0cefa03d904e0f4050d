package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_882);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_872);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_881);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_882:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_872:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_881:
