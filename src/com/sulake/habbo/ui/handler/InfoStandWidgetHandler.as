   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         if(this.var_245 != null)
         {
            ...
            this.var_245.events.addEventListener(SongInfoReceivedEvent.const_98,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_199,this.onUserTags);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_199,this.onUserTags);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_245 != null)
         {
            ...
            this.var_245.events.removeEventListener(SongInfoReceivedEvent.const_98,this.onSongInfoReceivedEvent);
            this.var_245 = null;
         }
         this.var_1142 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_578);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_805);
         _loc1_.push(RoomWidgetUserActionMessage.const_630);
         _loc1_.push(RoomWidgetUserActionMessage.const_557);
         _loc1_.push(RoomWidgetUserActionMessage.const_545);
         _loc1_.push(RoomWidgetUserActionMessage.const_511);
         _loc1_.push(RoomWidgetUserActionMessage.const_586);
         _loc1_.push(RoomWidgetUserActionMessage.const_461);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_1018);
         _loc1_.push(RoomWidgetFurniActionMessage.const_789);
         _loc1_.push(RoomWidgetFurniActionMessage.const_873);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1356);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_808);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_792);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_822);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1774);
         _loc1_.push(RoomWidgetPetCommandMessage.const_656);
         _loc1_.push(RoomWidgetPetCommandMessage.const_859);
         _loc1_.push(RoomWidgetUserActionMessage.const_613);
         _loc1_.push(RoomWidgetUserActionMessage.const_261);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_648)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_261 || param1.type == RoomWidgetUserActionMessage.const_613 || param1.type == RoomWidgetUserActionMessage.const_501)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_578:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_805:
            ...
            case RoomWidgetUserActionMessage.const_613:
               ...
               break;
            case RoomWidgetUserActionMessage.const_545:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1304,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_586:
               ...
               break;
            case RoomWidgetUserActionMessage.const_461:
            ...
            case RoomWidgetUserActionMessage.const_501:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_1018:
            ...
            case RoomWidgetFurniActionMessage.const_246:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_789:
            ...
            case RoomWidgetFurniActionMessage.const_873:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_1356:
               ...
               break;
            case RoomWidgetUserActionMessage.const_261:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_808:
            ...
            case RoomWidgetGetBadgeDetailsMessage.const_792:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_822:
            ...
            case RoomWidgetPetCommandMessage.const_859:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_656:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_254);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_371);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_415) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_415);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_987) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1320;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_254);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1296);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1395);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_582)
                  {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_495)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.method_2 = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_351);
               }
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_118)
               {
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_163)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_749);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1012;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_988;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1924);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_749);
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            _loc4_ = this._container.avatarRenderManager.method_4(param1,AvatarScaleType.const_62,null);
            if(_loc4_ != null)
            {
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_245 != null)
         {
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_433,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_245 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_437,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
