package com.sulake.habbo.ui.handler
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(InterstitialEvent.const_655);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_112);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_367);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case InterstitialEvent.const_641:
               ...
               break;
            case InterstitialEvent.const_655:
            ...
            case RoomWidgetLoadingBarUpdateEvent.const_112:
               ...
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_367:
               this._container.events.dispatchEvent(param1);
         }
      }
