package com.sulake.habbo.ui.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_3093:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_3093 = param1.root.assets;
      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_409:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_77,this.var_163,this.var_3001++,this,this._questEngine);
               break;
            case RoomWidgetEnum.const_350:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_77,this.var_163,this);
               break;
            case RoomWidgetEnum.const_547:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_77,this.var_163,this._catalog);
               break;
            case RoomWidgetEnum.const_629:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_77,events,this.var_163);
               break;
            ...
            case RoomWidgetEnum.const_647:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_77,this.var_163,this.var_13);
               break;
            ...
            case RoomWidgetEnum.const_657:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_77,this.var_163);
               break;
            case RoomWidgetEnum.const_500:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_77,this.var_163);
               break;
            case RoomWidgetEnum.const_129:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_77,this.var_163);
               break;
            ...
            case RoomWidgetEnum.const_121:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_163,this.var_77,this);
               break;
            ...
            case RoomWidgetEnum.const_539:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_77,this.var_163,this._catalog);
               break;
