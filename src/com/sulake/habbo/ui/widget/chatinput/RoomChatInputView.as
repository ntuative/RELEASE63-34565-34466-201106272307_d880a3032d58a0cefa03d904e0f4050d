package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1723:int = 250;
      
      private static const const_1724:int = 0;
      
      private static const BOTTOM_MARGIN:int = 55;
      
      private static const const_1725:String = "${widgets.chatinput.say}";
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1394 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_3026 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_3027 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_425 = new Timer(1000,1);
         this.var_425.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_501 = new Timer(10000,1);
         this.var_501.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_425.reset();
            this.var_425.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_425 = null;
         }
         if(this.var_501 != null)
         {
            this.var_501.reset();
            this.var_501.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_501 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2188 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_2187 = this._window.findChildByName("send_button_text");
         this.var_1691 = this._window.findChildByName("block_text");
         this.var_2187.caption = const_1725;
         this.var_28.setParamFlag(HabboWindowParam.const_45,true);
         this.var_28.addEventListener(WindowMouseEvent.const_43,this.windowMouseEventProcessor);
         this.var_28.addEventListener(WindowKeyboardEvent.const_185,this.windowKeyEventProcessor);
         this.var_28.addEventListener(WindowKeyboardEvent.const_344,this.keyUpHandler);
         ...
         this._window.addEventListener(WindowEvent.const_595,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_2188.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1723 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1724);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_28 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1394 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_28.text = "";
                  this.var_740 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_740.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_741);
