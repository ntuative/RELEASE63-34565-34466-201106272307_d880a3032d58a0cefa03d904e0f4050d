package com.sulake.habbo.ui.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_2371:uint = 4.282169599E9;
      ...
      private function highlightItem(param1:int) : void
      {
         ...
         if(this.var_1073 != -1)
         {
            ...
            if(_loc2_ != null)
            {
               _loc2_.color = !!(this.var_1073 % 2) ? uint(this.const_2086) : uint(this.const_2087);
            }
         }
         _loc2_ = this._itemList.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = this.const_2371;
      ...
      public function removeItem(param1:int, param2:int) : void
      {
         ...
         this.populate(this._items,this.var_2012);
      }
