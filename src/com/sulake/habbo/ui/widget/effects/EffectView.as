package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectView
   {
      ...
      private const const_2354:int = 1000;
      
      private var _widget:EffectsWidget;
      
      private var _window:IWindowContainer;
      
      private var var_135:IWidgetAvatarEffect;
      
      private var var_671:IWindow;
      
      private var var_331:Number;
      
      private var var_561:ITextWindow;
      
      private var var_223:Timer;
      
      private var var_672:IWindow;
      ...
      public function EffectView(param1:EffectsWidget, param2:IWidgetAvatarEffect)
      {
         ...
         this.var_135 = param2;
         this._widget = param1;
         this.var_223 = new Timer(this.const_2354);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_135.isActive)
         {
            _loc2_ = this.var_135.secondsLeft / Number(this.var_135.duration);
            this.var_671.width = _loc2_ * this.var_331;
         }
         else
         {
            this.var_671.width = 0;
            this.var_223.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_561 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_561 == null)
            {
               return;
            }
         ...
         if(!this.var_135.isActive)
         {
            this.var_561.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_561.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_561.text;
         var _loc2_:int = this.var_135.secondsLeft;
      ...
      public function update() : void
      {
         ...
         if(!this._window)
         {
            this._window = this._widget.windowManager.createWindow("","",HabboWindowType.const_79,HabboWindowStyle.const_30,HabboWindowParam.const_63) as IWindowContainer;
         }
         ...
         this.var_561 = null;
         var _loc2_:String = "";
         if(this.var_135.isInUse)
         {
            _loc2_ = "memenu_effect_selected";
         }
         else if(this.var_135.isActive)
         {
         ...
         else
         {
            ...
            this.var_672 = this._window.findChildByName("effect_hilite");
            this.var_672.visible = false;
         }
         this.setTimeLeft();
         this.var_671 = this._window.findChildByName("loader_bar");
         if(this.var_671 != null)
         {
            this.var_331 = this.var_671.width;
            this.var_223.start();
            this.onUpdate();
         }
         if(this.var_135.icon)
         {
            this.setElementBitmap("effect_icon",this.var_135.icon);
         }
      ...
      private function onMouseEvent(param1:WindowMouseEvent) : void
      {
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               this._widget.selectEffect(this.var_135.type,this.var_135.isInUse);
         }
      }
