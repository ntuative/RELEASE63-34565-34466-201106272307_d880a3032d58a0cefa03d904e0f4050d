package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private static const const_1446:Number = 100;
      ...
      private var var_438:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_79,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1447,const_1446,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            this.var_438 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
         this.var_288 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_288.numTabItems)
         {
            _loc6_ = this.var_288.getTabItemAt(_loc2_);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         if(this.var_438 != null)
         {
            this.var_438.setValue(this.var_1453);
         }
         this.var_581 = this.colors.indexOf(_loc2_.color);
         if(this.var_621 != null)
         {
            this.var_621.setSelectedColorIndex(this.var_581);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_288.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_288.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_288.selector.getSelected();
         return this.var_288.selector.getSelectableIndex(_loc1_);
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_438 != null)
         {
            this.var_438.min = this._widget.minLights[param1 - 1];
         }
      }
