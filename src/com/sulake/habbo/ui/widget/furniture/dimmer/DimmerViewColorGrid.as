package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_574:IItemGridWindow;
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= this.var_574.numGridItems)
         {
            return;
         }
         this.select(this.var_574.getGridItemAt(param1) as IWindowContainer);
      }
      
      private function populate(param1:IHabboWindowManager) : void
      {
         if(this._view == null || this.var_574 == null)
         {
            return;
         }
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         {
            _loc3_ = param1.buildFromXML(this.var_2027) as IWindowContainer;
            ...
            _loc3_.width = this.var_697.width;
            _loc3_.height = this.var_697.height;
            this.var_574.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_697.width,this.var_697.height,true,0);
               _loc4_.bitmap.copyPixels(this.var_697,this.var_697.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_1317.width,this.var_1317.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_1077.width,this.var_1077.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_1077,this.var_1077.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = this.var_574.getGridItemIndex(param1.target as IWindow);
