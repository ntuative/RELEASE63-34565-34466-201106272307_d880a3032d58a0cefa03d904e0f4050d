package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_2078:int = 0;
      
      private const const_2076:int = 1;
      ...
      private const const_2359:int = 1;
      
      private const const_2356:int = 2;
      
      private const const_2362:int = 3;
      ...
      private const const_2074:String = "dialog_bg";
      
      private const const_2361:String = "%campaign%_dialog_bg.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1560 = this.var_163.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1560 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1559.length)
         {
            _loc2_ = this.var_1559.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_163 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_994,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_869,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_523:
               ...
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_869:
               ...
               this._shareId = null;
               this.var_1561 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_994:
               _loc2_ = this.const_2076;
               this.var_238 = param1.objectId;
               this._shareId = param1.data;
               this.var_428 = param1.status;
               this.var_1561 = param1.itemCategory;
         ...
         if(this._window && (this.var_1558 != _loc2_ || _loc3_ != this.var_200))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_200 = _loc3_;
         this.var_1558 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1558)
            {
               case this.const_2078:
                  ...
                  break;
               case this.const_2076:
                  if(this.var_428 == this.const_2355)
                  {
                  ...
                  else if(this.var_428 == this.const_2359)
                  {
                  ...
                  else if(this.var_428 == this.const_2356)
                  {
                  ...
                  else if(this.var_428 == this.const_2362)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_428 == this.const_2358)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_200,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_428 == this.const_2357)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2361.replace("%campaign%",this.var_200);
            this.setDecoImage(_loc5_,this.const_2074);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this.var_13)
         {
            if(this.var_1561 != 0)
            {
               this.var_13.toggleInventoryPage(this.var_1561 == 1 ? "null" : InventoryCategory.const_132);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_841,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1559.push(new ImageDownloader(this,_assets,this.var_200,this.var_1560,param1,param2));
            return;
         }
