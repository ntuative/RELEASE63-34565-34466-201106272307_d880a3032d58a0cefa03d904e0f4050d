package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_724:String = "welcome_gift_email_unverified";
      
      private const const_1141:String = "welcome_gift_email_verified";
      
      private const const_1680:String = "welcome_gift_email_change";
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1357)
         {
            this.setViewState(this.const_1141);
         }
         else
         {
            this.setViewState(this.const_724);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_724:
               ...
               this._view.findChildByName("edit_text").visible = this.var_1118;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_1118);
               break;
            case this.const_1141:
            ...
            case this.const_1680:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_1118);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1662;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1680);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_795,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1357 ? this.const_1141 : this.const_724);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1661 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1661));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_628,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_1013,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_628,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_1013,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_628:
               this.var_1662 = param1.email;
               this.var_1357 = param1.isVerified;
               this.var_1118 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1662 = this.var_1661;
            this.setViewState(this.const_724);
         }
         else
         {
            if(param1.result == this.const_2374)
            {
               this.var_1118 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1661);
