package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandJukeboxView extends InfoStandFurniView
   {
      ...
      override protected function createWindow(param1:String) : void
      {
         ...
         var_265 = var_48.findChildByTag("catalog");
         if(var_265 != null)
         {
            var_265.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onCatalogButtonClicked);
         }
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_433)
         {
            this.var_1742 = param1.songId;
         }
         if(param1.songId == this.var_1742)
         {
            this._songName = param1.songName;
            this.var_2754 = param1.songAuthor;
            this.updateNowPlaying(this.var_1742 >= 0);
         }
      }
      ...
      private function updateNowPlaying(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            this.nowPlayingAuthorName = this.var_2754;
         }
         else
         {
