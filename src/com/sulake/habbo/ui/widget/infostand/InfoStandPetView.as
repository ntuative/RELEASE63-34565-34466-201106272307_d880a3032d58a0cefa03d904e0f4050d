package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1642:int = 152;
      
      private static const const_1636:int = 16;
      
      private static const const_720:int = 4;
      
      private static const const_1635:uint = 14342874;
      
      private static const const_1634:uint = 3815994;
      
      private static const const_1637:uint = 2085362;
      
      private static const const_1639:uint = 39616;
      
      private static const const_1644:uint = 10513106;
      
      private static const const_1631:uint = 8734654;
      
      private static const const_1638:uint = 9094430;
      
      private static const const_1641:uint = 6200576;
      
      private static const const_1643:String = "happiness";
      
      private static const const_1632:String = "experience";
      
      private static const const_1633:String = "energy";
      
      private static const const_1640:int = 250;
      
      private static const const_1124:int = 25;
      
      private static const const_1123:int = 5;
      ...
      private var var_226:PetCommandTool;
      ...
      {
         if(this.var_55 == null || this.var_48 == null || this.var_107 == null)
         {
            return;
         }
         ...
         this._window.width = Math.max(this.var_48.width,this.var_107.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_48.width < this.var_107.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1643,param1.nutrition,param1.nutritionMax,const_1639,const_1637);
         this.updateStateElement(const_1632,param1.experience,param1.experienceMax,const_1631,const_1644);
         this.updateStateElement(const_1633,param1.energy,param1.energyMax,const_1641,const_1638);
         ...
         this.updateWindow();
         this.var_531 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_226 && this.var_226.isVisible() && param1.isOwnPet)
         {
            this.var_226.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_226.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1642,const_1636,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1635);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1634);
      ...
      private function openTrainView() : void
      {
         if(this.var_226 == null)
         {
            this.var_226 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_531) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_226.showWindow(true);
            this.var_226.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_226 && this.var_226.getPetId() == this.var_531)
               {
                  this.var_226.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1801,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_461,this._widget.petData.ownerId);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1124 + const_1123;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1123;
            }
         }
         this.var_107.height = _loc4_ + const_1124;
         this.updateWindow();
      }
   }
}
