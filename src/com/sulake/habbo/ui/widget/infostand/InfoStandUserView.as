package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_148:IBorderWindow;
      
      private var var_2345:int;
      
      private var var_2346:Boolean = true;
      
      private const const_1039:int = 5;
      
      private const const_2346:int = 3;
      
      private const const_1444:int = 11184810;
      
      private const const_1445:int = 16777215;
      
      private const const_2344:int = 2000;
      
      private const const_2343:int = 50;
      
      private const const_2345:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_2346 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_148.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_148.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_148.x = _loc5_.left - this.var_148.width;
         this.var_148.y = _loc5_.top + (_loc5_.height - this.var_148.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_148.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_148.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_148.x = _loc7_.left - this.var_148.width;
         this.var_148.y = _loc7_.top + (_loc7_.height - this.var_148.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_148 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_148 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1039;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            if(param1 == "")
            {
               ...
               _loc5_.textColor = this.const_1444;
            }
            else
            {
               _loc5_.textColor = this.const_1445;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1039,this.const_2343);
         _loc5_.height = Math.max(_loc5_.height,this.const_2345);
         _loc3_.height = _loc5_.height + this.const_2346;
         if(param2)
         {
            _loc5_.addEventListener(WindowKeyboardEvent.const_344,this.onMottoKeyboard);
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc5_.removeEventListener(WindowKeyboardEvent.const_344,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_1012:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_988:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2345 > this.const_2344 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2345 = _loc6_;
               _loc3_.textColor = this.const_1445;
            }
         }
         else
         {
            _loc3_.textColor = this.const_1444;
         }
      }
