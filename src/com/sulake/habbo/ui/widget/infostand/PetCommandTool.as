package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_448:IFrameWindow;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_369 = new Timer(this.const_2347);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         if(_loc6_ == null)
         {
            ...
            this.requestEnabledCommands(this.var_531);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1189.getValue(this.var_531) as CommandConfiguration;
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_44.setParamFlag(WindowParam.const_101,true);
         ...
         this.var_44.position = const_1492;
      }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_448 == null)
         {
            ...
            this.var_448 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_448 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_448.x = 200;
            this.var_448.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_261,this.var_531));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_656,this.var_531,this.var_1789 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_656,this.var_531,this.var_1789 + " " + _loc5_);
