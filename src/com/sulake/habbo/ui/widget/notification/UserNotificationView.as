package com.sulake.habbo.ui.widget.notification
{
   ...
   public class UserNotificationView implements IDisposable
   {
      ...
      protected static const const_2054:String = "button_ok";
      
      protected static const const_2053:String = "text_title";
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            if(this.var_692)
            {
               while(this.var_692.length > 0)
               {
                  this.var_692.pop().dispose();
               }
               this.var_692 = null;
            }
            this._widget = null;
      ...
      public function showNotification(param1:String, param2:String) : Boolean
      {
         ...
         dialog.findChildByName(const_2053).caption = title;
         dialog.findChildByName(DESCRIPTION_NAME).caption = description;
         dialog.center();
         dialog.findChildByName(const_2054).addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,function(param1:WindowMouseEvent):void
         {
      ...
      public function hideNotification(param1:IFrameWindow) : void
      {
         ...
         if(param1 != null)
         {
            _loc2_ = this.var_692.indexOf(param1);
            if(_loc2_ > -1)
            {
