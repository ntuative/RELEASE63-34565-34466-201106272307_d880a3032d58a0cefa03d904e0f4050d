package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MainWindowHandler
   {
      ...
      private static const const_1495:int = 9;
      ...
      private var var_971:IBorderWindow;
      
      private var var_533:MusicInventoryGridView;
      
      private var var_794:PlayListEditorItemListView;
      
      private var var_244:MusicInventoryStatusView;
      
      private var var_318:PlayListStatusView;
      
      private var var_1808:IScrollbarWindow;
      
      private var var_1807:IScrollbarWindow;
      ...
      public function MainWindowHandler(param1:PlayListEditorWidget, param2:IHabboMusicController)
      {
         ...
         this._widget = param1;
         this.var_245 = param2;
         var _loc3_:Array = [PlayListEditorWidgetAssetsEnum.const_998,PlayListEditorWidgetAssetsEnum.const_816,PlayListEditorWidgetAssetsEnum.const_497,PlayListEditorWidgetAssetsEnum.const_513,PlayListEditorWidgetAssetsEnum.const_746];
         ...
         this.createWindow();
         this.var_533 = new MusicInventoryGridView(param1,this.getMusicInventoryGrid(),param2);
         ...
         this.var_318 = new PlayListStatusView(param1,this.getPlayListStatusContainer());
      ...
      public function destroy() : void
      {
         if(this.var_245)
         {
            this.var_245.stop(HabboMusicPrioritiesEnum.const_398);
            this.var_245 = null;
         }
         if(this.var_533)
         {
            this.var_533.destroy();
            this.var_533 = null;
         }
         if(this.var_794)
         {
      ...
      {
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_998)
         {
            this.assignWindowBitmapByAsset(this.var_972,"music_inventory_splash_image",PlayListEditorWidgetAssetsEnum.const_998);
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_816)
         {
            this.assignWindowBitmapByAsset(this.var_971,"playlist_editor_splash_image",PlayListEditorWidgetAssetsEnum.const_816);
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_497)
         {
            this.var_244.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_497));
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_513)
         {
            this.var_244.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_513));
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_746)
         {
            this.var_318.addSongsBackgroundImage = this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_746);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_971 = _loc2_.getChildByName("playlist_border") as IBorderWindow;
         ...
         this.var_1808 = this.var_972.getChildByName("music_inventory_scrollbar") as IScrollbarWindow;
         this.var_1807 = this.var_971.getChildByName("playlist_scrollbar") as IScrollbarWindow;
      ...
      {
         return this.var_971.getChildByName("playlist_editor_itemlist") as IItemListWindow;
      }
      ...
      {
         return this.var_971.getChildByName("now_playing_container") as IWindowContainer;
      }
      ...
      private function selectPlayListStatusViewByFurniPlayListState() : void
      {
         ...
         if(_loc1_.isPlaying)
         {
            this.var_318.selectView(PlayListStatusView.const_493);
         }
         else if(_loc1_.length > 0)
         {
            this.var_318.selectView(PlayListStatusView.const_1172);
         }
         else
         {
            this.var_318.selectView(PlayListStatusView.const_755);
         }
      }
      ...
      private function selectMusicStatusViewByMusicState() : void
      {
         ...
         {
            this.var_244.show();
            this.var_244.selectView(MusicInventoryStatusView.const_821);
         }
         else if(this.var_245.getSongDiskInventorySize() <= const_1493)
         {
            this.var_244.show();
            this.var_244.selectView(MusicInventoryStatusView.const_798);
         }
         else
         {
            this.var_244.hide();
      ...
      public function onPlayListUpdated() : void
      {
         ...
         if(_loc2_ != -1)
         {
            ...
            this.var_318.nowPlayingTrackName = _loc3_.name;
            this.var_318.nowPlayingAuthorName = _loc3_.creator;
         }
         this.var_1807.visible = _loc1_.length > const_1494;
      }
      
      public function onSongDiskInventoryReceived() : void
      {
         this.var_533.refresh();
         this.selectMusicStatusViewByMusicState();
         this.var_1808.visible = this.var_533.itemCount > const_1495;
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetPlayListEditorNowPlayingEvent.const_105:
               ...
               if(param1.id != -1)
               {
                  ...
                  this.var_318.nowPlayingTrackName = _loc3_ != null ? _loc3_.name : "";
                  this.var_318.nowPlayingAuthorName = _loc3_ != null ? _loc3_.creator : "";
               }
               break;
            case RoomWidgetPlayListEditorNowPlayingEvent.const_123:
               this.var_533.setPreviewIconToPause();
            ...
            case RoomWidgetPlayListEditorNowPlayingEvent.const_134:
               this.var_533.setPreviewIconToPlay();
               this.selectMusicStatusViewByMusicState();
         }
      }
      ...
      {
         return this.var_245.getSongIdPlayingAtPriority(HabboMusicPrioritiesEnum.const_398) != -1;
      }
   }
}
