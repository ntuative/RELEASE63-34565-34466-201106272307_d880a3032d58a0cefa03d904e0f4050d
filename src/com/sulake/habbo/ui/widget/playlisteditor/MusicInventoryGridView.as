package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      private var var_712:IItemGridWindow;
      ...
      public function refresh() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            this.var_712.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_113.playButtonState = MusicInventoryGridItem.const_1360;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_113 != null)
         {
            this.var_113.playButtonState = MusicInventoryGridItem.const_662;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc3_:* = param1.type == WindowMouseEvent.const_153;
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_113.playButtonState == MusicInventoryGridItem.const_662)
               {
                  this.var_113.playButtonState = MusicInventoryGridItem.const_1278;
            ...
            {
               _loc4_ = this.var_712.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
