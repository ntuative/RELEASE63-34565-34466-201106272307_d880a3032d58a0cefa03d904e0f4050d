package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_798:String = "MISV_BUY_MORE";
      
      public static const const_821:String = "MISV_PREVIEW_PLAYING";
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_435.getValues())
         {
            _loc1_.destroy();
         }
         this.var_435 = null;
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_435[param1] as IWindowContainer,0);
         this.var_53 = param1;
      }
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_1795.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_821,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_798,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_435.add(const_821,_loc1_);
            this.var_1796 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_1795 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_497));
         ...
         if(_loc1_ != null)
         {
            this.var_435.add(const_798,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_513));
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_435[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
