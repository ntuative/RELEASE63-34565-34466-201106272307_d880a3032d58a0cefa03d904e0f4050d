package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_755:String = "PLSV_ADD_SONGS";
      
      public static const const_1172:String = "PLSV_START_PLAYBACK";
      
      public static const const_493:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_53 != const_493)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_435[this.var_53];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_435[const_755];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_435.add(const_493,_loc1_);
