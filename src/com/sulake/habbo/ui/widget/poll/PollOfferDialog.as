package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_1928:String = "POLL_OFFER_STATE_OK";
      
      public static const const_862:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_109:String = "POLL_OFFER_STATE_UNKNOWN";
      ...
      {
         if(this._state != const_109)
         {
            return;
         }
         this._state = const_1928;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_891,this._id));
      }
      ...
      private function onCancel(param1:WindowEvent) : void
      {
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_537,this._id));
