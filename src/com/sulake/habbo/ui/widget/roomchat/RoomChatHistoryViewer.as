package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1713:int = 18;
      ...
      private var var_208:RoomChatHistoryPulldown;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_1142 = false;
         this._widget = param1;
         this.var_208 = new RoomChatHistoryPulldown(param1,param2,param3,param4);
         this.var_208.state = RoomChatHistoryPulldown.const_247;
         ...
         this.var_54 = param2.createWindow("chatscroller","",HabboWindowType.const_1249,HabboWindowStyle.const_47,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_208.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_247);
      }
      ...
      {
         return !!this.var_499 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_208.state == RoomChatHistoryPulldown.const_441 || this.var_208.state == RoomChatHistoryPulldown.const_563;
      }
      ...
      {
         if(!this.var_499 && !this.var_1833)
         {
            this.var_499 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_208.state = RoomChatHistoryPulldown.const_441;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_54 != null)
         {
            ...
            if(param2)
            {
               this.var_54.scrollV = this.var_738;
            }
         }
         if(this.var_208 != null)
         {
            this.var_208.containerResized(param1);
         }
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_500 > 0 && param2)
         {
            if(this.var_2185)
            {
               if(Math.abs(param1 - this.var_500) <= const_1383)
               {
                  return;
               }
               this.var_2185 = false;
            ...
            if(this.var_499)
            {
               ...
               _loc5_ = (param1 - this.var_500) / this.var_54.height;
               _loc3_ = this.var_738 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_500;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_54.scrollV < 1 - const_1713 / this.var_54.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_2184)
               {
                  this._widget.method_11(_loc6_);
                  _loc7_ = false;
                  this.var_54.scrollV = 1;
               }
               if(_loc7_)
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_54 != null)
         {
            this.var_738 = this.var_54.scrollV;
         }
         if(this.var_54 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_738 - this.var_54.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
