package com.sulake.habbo.utils
{
   ...
   public class WindowToggle implements IDisposable
   {
      ...
      public static const const_1850:int = 1;
      ...
      private var var_1498:Function;
      
      private var var_988:Function;
      ...
      public function show() : void
      {
         ...
         {
            if(this._window.parent != this.var_987)
            {
               this.var_987.addChild(this._window);
            }
