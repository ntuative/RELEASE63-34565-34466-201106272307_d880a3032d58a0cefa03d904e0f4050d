package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_467:uint = 3;
      
      private static const const_1432:uint = 1;
      ...
      private var var_1437:IEventDispatcher;
      
      private var var_1161:Boolean = false;
      
      private var var_1726:ProfilerOutput;
      
      private var var_1438:ProfilerAgentTask;
      
      private var var_1436:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_210 = new Array(const_467);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_467)
         {
            this.var_210[_loc6_] = new WindowContext("layer_" + _loc6_,this._windowRenderer,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_663 = this.var_210[const_1432];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1726)
            {
               this.var_1726 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_1726.profiler = _loc3_;
            ...
            this.var_1436 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1436);
            this.var_1161 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_210)
            {
               while(this.var_210.length > 0)
               {
                  IDisposable(this.var_210.pop()).dispose();
               }
            }
            this.var_210 = null;
            if(this.var_269)
      ...
      {
         return this.var_663.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_663.getWindowParser().windowToXMLString(param1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = this.var_269[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_269[0][param1] as XML : _loc4_;
      }
      ...
      {
         return this.var_210[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_210[param2].getDesktopWindow();
      ...
      {
         return this.var_210[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function method_10(param1:uint = 1) : IWindow
      {
         return this.var_210[param1].getDesktopWindow().getChildAt(this.var_663.getDesktopWindow().numChildren - 1);
      }
      
      public function getWindowContext(param1:uint) : IWindowContext
      {
         return this.var_210[param1];
      }
      
      public function getDesktop(param1:uint) : IDesktopWindow
      {
         var _loc2_:IWindowContext = this.var_210[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1437.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_467 - 1;
            while(_loc2_ >= 0)
            {
               this.var_210[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1161)
         ...
         this.var_1437.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_467)
         {
            this.var_210[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1161)
         {
         ...
         this.var_1437.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1895,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1795,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1891,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1833,param2.name + ": " + param2.toString());
            }
         }
      }
