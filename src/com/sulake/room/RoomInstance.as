   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_306 != null)
         {
            ...
            {
               _loc3_ = this.var_306.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_716.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_716[_loc2_]);
      ...
      {
         return this.var_306.getKeys();
      }
      
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         var _loc2_:String = String(param1);
         if(this.var_306.getValue(_loc2_) != null)
         {
            return this.var_306.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
      ...
      {
         return this.var_306.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_306.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_306.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
