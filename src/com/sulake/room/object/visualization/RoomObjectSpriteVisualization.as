package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_410:IRoomObject;
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_228.length > 0)
            {
               _loc1_ = this.var_228[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_890.removeReference();
         }
         this.var_890 = param1;
         if(this.var_890 != null)
         {
            this.var_890.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_228.length > param1)
         {
            _loc2_ = this.var_228[this.var_228.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
         ...
         while(this.var_228.length < param1)
         {
            ...
            this.var_228.push(_loc2_);
         }
      }
      
      public function get spriteCount() : int
      {
         return this.var_228.length;
      }
