package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_695:Point = new Point(0,0);
      
      private static const const_385:int = 50;
      
      private static const const_1519:int = 50;
      
      private static const const_1080:Number = 60;
      
      private static const const_1518:Number = 50;
      ...
      private var var_649:RoomObjectCache;
      
      private var var_541:Array;
      
      private var var_651:Array;
      
      private var var_1500:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2554:Number = -1.0E7;
      ...
      private var var_1858:Number = 0.0;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_277 = new BitmapDataCache(16,32,1);
         var _loc6_:* = null;
         ...
         this.var_649 = new RoomObjectCache(_loc6_);
         this.var_793 = new ColorTransform();
         this.var_648 = new Matrix();
      ...
      {
         this.var_543.x -= param1 - this.var_652;
         this.var_652 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_543.y -= param1 - this.var_653;
         this.var_653 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_967 = true;
            if(this.var_152 != null && !this.var_278.contains(this.var_152))
            {
               this.var_278.addChild(this.var_152);
         ...
         else if(!param1 && this.var_967)
         {
            ...
            if(this.var_152 != null && this.var_278.contains(this.var_152))
            {
               this.var_278.removeChild(this.var_152);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_278.numChildren > 0)
            {
               this.var_278.removeChildAt(0);
            }
            this.var_278 = null;
         }
         this.var_112 = null;
         ...
         if(this.var_651 != null)
         {
            ...
            {
               this.cleanSprite(this.var_651[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_651 = [];
         }
      ...
      {
         this.var_649.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_1855 = !this.var_1855;
         ...
         if(this.var_540 != this.var_2550 || this.var_542 != this.var_2552)
         {
            _loc8_ = true;
         }
         if(this.var_112.x != this.var_652 || this.var_112.y != this.var_653)
         {
            this.var_112.x = this.var_652;
            this.var_112.y = this.var_653;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_541.sortOn("z",0 | 0);
         if(_loc5_ < this.var_541.length)
         {
            this.var_541.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_541[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2550 = this.var_540;
         this.var_2552 = this.var_542;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1501 > 0)
         {
            _loc2_ = param1 - this.var_1501;
            if(_loc2_ > const_1080 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2548 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_810;
               if(this.var_810 == const_385 + 1)
               {
                  this.var_519 = _loc2_;
                  this.var_1858 = this.var_2553;
               }
               else if(this.var_810 > const_385 + 1)
               {
                  _loc3_ = Number(this.var_810 - const_385);
                  this.var_519 = this.var_519 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1858 = this.var_1858 * (_loc3_ - 1) / _loc3_ + Number(this.var_2553) / _loc3_;
                  if(this.var_810 > const_385 + const_1519)
                  {
                     this.var_810 = const_385;
                     if(!this.var_1218 && this.var_519 > const_1080)
                     {
                        this.var_1218 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1218 && this.var_519 < const_1518)
                     {
                        this.var_1218 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_649.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_649.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1855 && this.var_1218);
         ...
         _loc13_ += int(this.var_540 / 2);
         _loc14_ += int(this.var_542 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_652;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_653;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_541.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_652;
                     _loc17_.y = _loc20_ - this.var_653;
      ...
      {
         if(param1 < this.var_540 && param1 + param3 >= 0 && (param2 < this.var_542 && param2 + param4 >= 0))
         {
            if(!this.var_3072)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_540)
         {
            param3 -= this.var_540 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_542)
         {
            param4 -= this.var_542 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2551)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_991)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(this.var_651.length > 0)
         {
            _loc3_ = this.var_651.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_991)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_809 || this.var_809 == 0)
         {
            _loc4_ = this.var_991 - 1;
            while(_loc4_ >= param1)
            {
      ...
      private function getSortableSprite(param1:int) : SortableSprite
      {
         ...
         return this.var_541[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:Boolean, param5:int) : BitmapData
      {
         ...
         if((param3 || param4) && param5 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc6_ = this.var_277.getBitmapData(_loc7_);
            }
            if(_loc6_ == null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_277.addBitmapData(_loc7_,_loc6_);
                  }
                  return _loc6_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_648.identity();
            if(flipH)
            {
               this.var_648.scale(-1,1);
               this.var_648.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_648.scale(1,-1);
               this.var_648.translate(0,data.height);
            }
            finalData.draw(data,this.var_648);
            if(name.length > 0)
            {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_695);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_793.redMultiplier = tR;
            this.var_793.greenMultiplier = tG;
            this.var_793.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_793);
            if(name.length > 0)
            {
               this.var_277.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(this.var_1217 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1856;
         }
         this.var_1856 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1217;
         return this.var_1856;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_540 / 2;
         var _loc12_:Number = param2 - this.var_542 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1857,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2549 || param2 != this.var_2554)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         while(_loc1_ < this.var_377.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1500.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
