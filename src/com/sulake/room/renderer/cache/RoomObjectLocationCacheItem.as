package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1779 || param1.getUpdateID() != this.var_2770)
         {
            this.var_2770 = param1.getUpdateID();
            if(param2.updateId != this.var_1779 || _loc4_.x != this.var_1311.x || _loc4_.y != this.var_1311.y || _loc4_.z != this.var_1311.z)
            {
