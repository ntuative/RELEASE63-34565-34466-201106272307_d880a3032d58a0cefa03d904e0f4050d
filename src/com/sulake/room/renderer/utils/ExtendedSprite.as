package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      {
         if(param1 != this.var_2084 || param2 != this.var_2083)
         {
      ...
      {
         if(this.var_1639 > 255 || bitmapData == null)
         {
            return false;
         }
         if(param1 < 0 || param2 < 0 || param1 >= this.var_234 || param2 >= this._height)
         {
            return false;
         }
