package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_645:Number = 64;
      
      public static const const_1283:Number = 32;
      ...
      private var var_1290:Vector3d;
      
      private var _scale:Number = 1.0;
      
      private var var_470:Number = 1.0;
      
      private var var_469:Number = 1.0;
      
      private var var_471:Number = 1.0;
      
      private var var_1953:Number = 1.0;
      
      private var var_1952:Number = 1.0;
      
      private var var_1951:Number = 1.0;
      
      private var var_104:Vector3d;
      
      private var var_473:Vector3d;
      
      private var var_3081:Number = -500.0;
      
      private var var_3082:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1289 = new Vector3d();
         this.var_472 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1290 = new Vector3d();
         this.var_1953 = 1;
         this.var_1952 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1951 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_472.assign(this.var_104);
         this.var_472.x *= this.var_470;
         this.var_472.y *= this.var_469;
         this.var_472.z *= this.var_471;
         return this.var_472;
      }
      ...
      {
         if(this.var_470 != param1 * this.var_1953)
         {
            this.var_470 = param1 * this.var_1953;
            ++this.var_174;
         }
      }
      ...
      {
         if(this.var_469 != param1 * this.var_1952)
         {
            this.var_469 = param1 * this.var_1952;
            ++this.var_174;
         }
      }
      ...
      {
         if(this.var_471 != param1 * this.var_1951)
         {
            this.var_471 = param1 * this.var_1951;
            ++this.var_174;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_104.x /= this.var_470;
         this.var_104.y /= this.var_469;
         this.var_104.z /= this.var_471;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_186.assign(_loc24_);
            this.var_187.assign(_loc25_);
            this.var_1289.assign(this.var_187);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_186.assign(_loc19_);
            this.var_187.assign(_loc20_);
            this.var_1289.assign(this.var_187);
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_563 != null)
         {
            ...
            return this.var_563.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1290.assign(_loc22_);
         }
         else
         {
            this.var_1290.assign(_loc17_);
         }
         ++this.var_174;
      }
      ...
      public function adjustLocation(param1:IVector3d, param2:Number) : void
      {
         ...
         var _loc3_:Vector3d = Vector3d.product(this.var_187,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_186);
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_187);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_470;
         _loc2_.y *= this.var_469;
         _loc2_.z *= this.var_471;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1290);
         if(_loc3_ < this.var_3081 || _loc3_ > this.var_3082)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_186);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_469;
            _loc2_.z *= this.var_471;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1290);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         _loc7_.add(Vector3d.product(this.var_186,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_104.x * this.var_470,this.var_104.y * this.var_469,this.var_104.z * this.var_471);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_187;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_470,param2.y * this.var_469,param2.z * this.var_471);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_470,param3.y * this.var_469,param3.z * this.var_471);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_470,param4.y * this.var_469,param4.z * this.var_471);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1283;
         }
         else
         {
            this.scale = const_645;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_645;
      }
